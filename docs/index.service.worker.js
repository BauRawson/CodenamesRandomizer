...
/** @type {string} */
const CACHE_VERSION = '1736882515|13654291939';
/** @type {string} */
const CACHE_PREFIX = 'CodigoRandomizer-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["index.html","index.js","index.offline.html","index.icon.png","index.apple-touch-icon.png","index.service.worker.js","index.audio.worklet.js"];
