(function(){function za(d,u){var b=Object.keys(d);if(Object.getOwnPropertySymbols){var h=Object.getOwnPropertySymbols(d);u&&(h=h.filter(function(X){return Object.getOwnPropertyDescriptor(d,X).enumerable})),b.push.apply(b,h)}return b}function ye(d){for(var u=1;u<arguments.length;u++){var b=arguments[u]!=null?arguments[u]:{};u%2?za(Object(b),!0).forEach(function(h){hn(d,h,b[h])}):Object.getOwnPropertyDescriptors?Object.defineProperties(d,Object.getOwnPropertyDescriptors(b)):za(Object(b)).forEach(function(h){Object.defineProperty(d,h,Object.getOwnPropertyDescriptor(b,h))})}return d}function hn(d,u,b){return(u=wn(u))in d?Object.defineProperty(d,u,{value:b,enumerable:!0,configurable:!0,writable:!0}):d[u]=b,d}function wn(d){var u=yn(d,"string");return typeof u=="symbol"?u:u+""}function yn(d,u){if(typeof d!="object"||!d)return d;var b=d[Symbol.toPrimitive];if(b!==void 0){var h=b.call(d,u||"default");if(typeof h!="object")return h;throw new TypeError("@@toPrimitive must return a primitive value.")}return(u==="string"?String:Number)(d)}function Oa(d,u,b,h,X,se,V){try{var D=d[se](V),w=D.value}catch(P){return void b(P)}D.done?u(w):Promise.resolve(w).then(h,X)}function ea(d){return function(){var u=this,b=arguments;return new Promise(function(h,X){var se=d.apply(u,b);function V(w){Oa(se,h,X,V,D,"next",w)}function D(w){Oa(se,h,X,V,D,"throw",w)}V(void 0)})}}System.register([],function(d,u){"use strict";var b,h,X,se,V,D,w,P,me,Te,T,f,Qe,M,p,te,Pe,ja,Da,C,ke,Fa,ge,W,Be,k,qe,B,U,ee,aa,Re,G,K,xe,F,na,Ge,$,be,$e,oa,Ne,ze,ia,Ha,Ce,ra,v,A,fe,S,L,N,sa,ta,la,ca,da,le,ua,z,Oe,ae,ne,je,ce,de,De,Fe,pa,He,Ja,Je,_,Ee,R,Me,Ve,ve,x,E,m,g,O,c,Y,ma,oe,We,Ue,ga,Ae,H,ba,ue,Q,I,fa;function Va(){return va.apply(this,arguments)}function va(){return va=ea(function*(){return D||(D=(yield se(()=>u.import("./bundler-legacy-bE7ZcOuf.js"),void 0)).default),D}),va.apply(this,arguments)}function ha(e){return wa.apply(this,arguments)}function wa(){return wa=ea(function*(e){let a;try{a=yield Va()}catch{T("error",{type:"peerjs-unavailable"});return}w=new a(V+e),w.on("open",()=>T("ready")),w.on("connection",n=>{me.push(n),n.on("open",()=>T("connected",n)),n.on("data",o=>T("message",o,n)),n.on("close",()=>{me=me.filter(o=>o!==n),T("peer-left",n)})}),w.on("error",n=>T("error",n))}),wa.apply(this,arguments)}function ya(e){return qa.apply(this,arguments)}function qa(){return qa=ea(function*(e){let a;try{a=yield Va()}catch{T("error",{type:"peerjs-unavailable"});return}w=new a,w.on("open",()=>{P=w.connect(V+e,{reliable:!0}),P.on("open",()=>T("connected")),P.on("data",n=>T("message",n)),P.on("close",()=>T("disconnected")),P.on("error",n=>T("error",n))}),w.on("error",n=>T("error",n))}),qa.apply(this,arguments)}function Se(){w&&(w.destroy(),w=null),P=null,me=[],Te.clear()}function Wa(){const e=Math.random()<.5,a=[...Array(e?9:8).fill(0),...Array(e?8:9).fill(1),...Array(7).fill(2),...Array(1).fill(3)];for(let i=a.length-1;i>0;i--){const s=Math.floor(Math.random()*(i+1));[a[i],a[s]]=[a[s],a[i]]}const n=[...Da];for(let i=n.length-1;i>0;i--){const s=Math.floor(Math.random()*(i+1));[n[i],n[s]]=[n[s],n[i]]}const o=n.slice(0,25);return{tiles:a,isTeamOneFirst:e,words:o}}function Ca(e){e.animate&&e.animate([{transform:"scale(0.88)",opacity:.6},{transform:"scale(1.06)",opacity:1},{transform:"scale(1)",opacity:1}],{duration:240,easing:"ease-out",fill:"none"})}function he(e){const a=document.createElement("canvas");a.style.cssText="position:fixed;top:0;right:0;bottom:0;left:0;inset:0;width:100%;height:100%;pointer-events:none;z-index:999",document.body.appendChild(a);const n=a.getContext("2d");a.width=window.innerWidth,a.height=window.innerHeight;const i=Array.from({length:120},()=>({x:Math.random()*a.width,y:-20-Math.random()*80,vx:(Math.random()-.5)*4,vy:2+Math.random()*4,rot:Math.random()*Math.PI*2,vrot:(Math.random()-.5)*.2,w:8+Math.random()*8,h:5+Math.random()*5,color:Math.random()<.6?e:"#fbb954",alpha:1}));let s;const l=()=>{n.clearRect(0,0,a.width,a.height);let r=!1;for(const t of i)t.x+=t.vx,t.y+=t.vy,t.vy+=.08,t.rot+=t.vrot,t.y>a.height*.85&&(t.alpha-=.03),!(t.alpha<=0)&&(r=!0,n.save(),n.globalAlpha=t.alpha,n.translate(t.x,t.y),n.rotate(t.rot),n.fillStyle=t.color,n.fillRect(-t.w/2,-t.h/2,t.w,t.h),n.restore());r?s=requestAnimationFrame(l):a.remove()};s=requestAnimationFrame(l),setTimeout(()=>{cancelAnimationFrame(s),a.remove()},4e3)}function y({freq:e=440,end:a,dur:n=.15,vol:o=.28,type:i="sine",at:s=0}){const l=Fa(),r=l.createOscillator(),t=l.createGain();r.connect(t),t.connect(l.destination),r.type=i,r.frequency.setValueAtTime(e,l.currentTime+s),a!=null&&r.frequency.exponentialRampToValueAtTime(a,l.currentTime+s+n),t.gain.setValueAtTime(o,l.currentTime+s),t.gain.exponentialRampToValueAtTime(.001,l.currentTime+s+n),r.start(l.currentTime+s),r.stop(l.currentTime+s+n+.05)}function Ea(e){y(e===0?{freq:523,end:659,dur:.12,vol:.25}:e===1?{freq:349,end:440,dur:.12,vol:.25}:e===2?{freq:420,end:400,dur:.09,vol:.12}:{freq:180,end:70,dur:.28,vol:.35,type:"sawtooth"})}function Ma(){y({freq:420,end:300,dur:.08,vol:.1})}function Ua(e){const a=e===0?523:440;[1,1.25,1.5,2,2.5].forEach((n,o)=>y({freq:a*n,dur:.18,vol:.28,at:o*.11}))}function Aa(){y({freq:660,end:220,dur:.22,vol:.18,type:"triangle"})}function Sa(){y({freq:900,end:750,dur:.06,vol:.14,type:"square"})}function Ka(){y({freq:260,end:140,dur:.35,vol:.28,type:"sawtooth"})}function Ke(){y({freq:440,end:523,dur:.13,vol:.22}),y({freq:660,end:784,dur:.22,vol:.3,at:.11})}function _a(){y({freq:260,end:140,dur:.3,vol:.22,type:"sawtooth"})}function Le(){y({freq:620,end:520,dur:.04,vol:.09})}function Ya(){[523,659,784,1047,784,1047,1319].forEach((e,a)=>y({freq:e,end:e*.96,dur:.22,vol:.3,at:a*.1}))}function Za(){y({freq:480,end:450,dur:.09,vol:.1})}function La(){y({freq:440,end:560,dur:.12,vol:.14})}function qn(){y({freq:330,end:660,dur:.2,vol:.13,type:"triangle"})}function Cn(e){k=null,qe=null,B=[],U=null,ee=new Array(25).fill(null);const a=Qe();e.innerHTML=`
    <div class="scene">
  ...
  `,f("connected",()=>{}),f("peer-left",n=>{n===k&&(k=null),B=B.filter(o=>o!==n),Xa()}),f("message",(n,o)=>{if(n.type==="cs-hello"){En(o,n.clientId);return}n.type==="board"&&(U=ye({},n),ee=new Array(25).fill(null),Mn(e,n),B.filter(i=>i.open).forEach(i=>p(i,ye({type:"board-update"},n)))),n.type==="reveal"&&(ee[n.index]={color:n.color,tileType:n.tileType},Sn(n.index,n.color,n.tileType),B.filter(i=>i.open).forEach(i=>p(i,{type:"reveal",index:n.index,color:n.color}))),n.type==="hide"&&(ee[n.index]=null,Ln(n.index,n.tileType),B.filter(i=>i.open).forEach(i=>p(i,{type:"hide",index:n.index}))),n.type==="win"&&(In(n.team,e),B.filter(i=>i.open).forEach(i=>p(i,{type:"win",team:n.team})))}),f("error",n=>{const o=document.getElementById("status");o&&(o.textContent=`Error: ${n.type}`)}),ha(a)}function En(e,a){var n;const o=a&&a===qe,i=!((n=k)!==null&&n!==void 0&&n.open);o||i?(k&&k!==e&&(B.push(k),U?p(k,{type:"sync",role:"spectator",board:U,revealed:ee}):p(k,{type:"role",role:"spectator"})),k=e,qe=a||qe,U?p(e,{type:"sync",role:"captain",board:U,revealed:ee}):p(e,{type:"role",role:"captain"})):(B.includes(e)||B.push(e),U?p(e,{type:"sync",role:"spectator",board:U,revealed:ee}):p(e,{type:"role",role:"spectator"})),Xa()}function Xa(){var e;const a=document.getElementById("status");if(!a)return;const n=B.filter(i=>i.open).length,o=[];(e=k)!==null&&e!==void 0&&e.open&&o.push("¡Capitán conectado!"),n>0&&o.push(`${n} espectador${n>1?"es":""} conectado${n>1?"s":""}`),a.textContent=o.length?o.join(" · "):"Esperando al móvil…"}function Mn(e,a){ge=[];const n=C[a.isTeamOneFirst?0:1];Be=[a.tiles.filter(i=>i===0).length,a.tiles.filter(i=>i===1).length],W=[...Be],e.innerHTML=`
    <div class="scene board-scene">
      <div class="team-banner" style="background:${n}22; border-bottom:3px solid ${n}">
        <div class="counters">
          <span class="counter" id="c0" style="color:${C[0]}">${W[0]}</span>
          <span class="counter" id="c1" style="color:${C[1]}">${W[1]}</span>
        </div>
      </div>
  ...
  `;const o=document.getElementById("board");a.tiles.forEach((i,s)=>{var l;const r=document.createElement("div");r.className="tile tile-neutral",r.innerHTML=`<span class="tile-word">${(l=a.words[s])!==null&&l!==void 0?l:""}</span>`,o.appendChild(r),ge.push(r)}),requestAnimationFrame(()=>ge.forEach(An))}function An(e){const a=e.querySelector(".tile-word");if(!a)return;let n=parseFloat(getComputedStyle(a).fontSize);for(;a.scrollWidth>a.clientWidth+1&&n>9;)n-=.5,a.style.fontSize=`${n}px`;a.scrollWidth>a.clientWidth+1&&(a.style.letterSpacing="0"),a.scrollWidth>a.clientWidth+1&&(a.style.whiteSpace="normal")}function Sn(e,a,n){const o=ge[e];if(o){if(o.style.background=a,o.dataset.type=n,o.classList.remove("tile-neutral"),o.classList.add("revealed"),n===2){const i=o.querySelector(".tile-word");i&&(i.style.color="rgba(255,255,255,0.92)")}Ca(o),Ea(n),(n===0||n===1)&&(W[n]=Math.max(0,W[n]-1),en(n))}}function Ln(e,a){const n=ge[e];if(!n)return;n.style.background="",n.classList.remove("revealed"),n.classList.add("tile-neutral");const o=n.querySelector(".tile-word");o&&(o.style.color=""),Ma(),(a===0||a===1)&&(W[a]=Math.min(Be[a],W[a]+1),en(a))}function en(e){const a=document.getElementById(`c${e}`);a&&(a.textContent=W[e])}function In(e,a){Ua(e);const n=C[e],o=e===0?"EQUIPO 1":"EQUIPO 2";he(n);const i=document.createElement("div");i.className="win-overlay",i.innerHTML=`<div class="win-text" style="color:${n}">${o} GANA!</div>`,a.appendChild(i)}function _e(){try{let l=localStorage.getItem(aa);if(!l){var e,a,n;l=(e=(a=(n=crypto).randomUUID)===null||a===void 0?void 0:a.call(n))!==null&&e!==void 0?e:`${Date.now()}-${Math.random().toString(36).slice(2)}`,localStorage.setItem(aa,l)}return l}catch{var o,i,s;return(o=(i=(s=crypto).randomUUID)===null||i===void 0?void 0:i.call(s))!==null&&o!==void 0?o:`${Date.now()}-${Math.random().toString(36).slice(2)}`}}function Ia(e){sessionStorage.setItem(Re,JSON.stringify(ye(ye({},e),{},{savedAt:Date.now()})))}function Ta(){try{const e=sessionStorage.getItem(Re);return e?JSON.parse(e):null}catch{return null}}function Ye(){sessionStorage.removeItem(Re)}function Tn(e){$=e,Qn(),e.innerHTML=`
    <div class="scene">
      <h1 class="title">CODIGO</h1>
  ...
  `;const a=document.getElementById("code-input"),n=document.getElementById("connect-btn"),o=document.getElementById("status"),i=()=>{const s=a.value.trim();if(s.length!==4){o.textContent="Ingresa el código de 4 dígitos completo";return}n.disabled=!0,o.textContent="Conectando…",an(s)};n.onclick=i,a.addEventListener("keydown",s=>{s.key==="Enter"&&i()})}function an(e){$e=e,Ia({mode:"cs",code:e}),Se(),f("connected",()=>{const a=document.getElementById("status");a&&(a.textContent="Conectado, esperando…"),M({type:"cs-hello",clientId:_e()})}),f("message",a=>{a.type==="role"&&(a.role==="captain"&&Ze($),a.role==="spectator"&&Qa($,null,[])),a.type==="sync"&&(a.role==="captain"&&Ze($,a.board,a.revealed),a.role==="spectator"&&Qa($,a.board,a.revealed)),a.type==="board-update"&&Qa($,a,new Array(25).fill(null)),a.type==="reveal"&&on(a.index,a.color),a.type==="hide"&&Bn(a.index),a.type==="win"&&Rn(a.team,$)}),f("error",a=>{const n=document.getElementById("status"),o=document.getElementById("connect-btn");n&&(n.textContent=a.type==="peer-unavailable"?"❌ Código incorrecto — revisa el televisor":`❌ ${a.type}`),o&&(o.disabled=!1)}),ya(e)}function Qn(){if(oa)return;oa=!0;const e=()=>{if(document.visibilityState!=="visible"||!$e)return;const a=Ta();a?.mode==="cs"&&(Pe()||an($e))};document.addEventListener("visibilitychange",e),window.addEventListener("focus",e),window.addEventListener("online",e)}function Ze(e,a=null,n=null){$=e,G=a||Wa(),Ge=!1,xe=[],K=n?n.map(s=>s!==null):new Array(25).fill(!1),na=[G.tiles.filter(s=>s===0).length,G.tiles.filter(s=>s===1).length],F=[G.tiles.filter((s,l)=>s===0&&!K[l]).length,G.tiles.filter((s,l)=>s===1&&!K[l]).length];const o=C[G.isTeamOneFirst?0:1];e.innerHTML=`
    <div class="scene board-scene">
      <div class="team-banner" style="background:${o}22; border-bottom:3px solid ${o}">
        <div class="counters">
          <span class="counter" id="c0" style="color:${C[0]}">${F[0]}</span>
          <span class="counter" id="c1" style="color:${C[1]}">${F[1]}</span>
        </div>
      </div>
  ...
  `;const i=document.getElementById("board");G.tiles.forEach((s,l)=>{var r;const t=document.createElement("div");t.className="tile",t.dataset.type=s,t.style.background=C[s],t.innerHTML=`<span class="tile-word">${(r=G.words[l])!==null&&r!==void 0?r:""}</span>`,t.addEventListener("click",()=>Pn(l,t)),K[l]&&t.classList.add("checked"),i.appendChild(t),xe.push(t)}),requestAnimationFrame(()=>xe.forEach(rn)),a||M(ye({type:"board"},G)),document.getElementById("new-board-btn").addEventListener("click",()=>{confirm("¿Generar un nuevo tablero? Esto reinicia el televisor también.")&&(Aa(),Ze(e))})}function Pn(e,a){if(Ge)return;K[e]=!K[e],a.classList.toggle("checked",K[e]);const n=G.tiles[e];K[e]?(Ca(a),Ea(n),M({type:"reveal",index:e,color:C[n],tileType:n}),(n===0||n===1)&&(F[n]=Math.max(0,F[n]-1),nn(n),kn(n))):(Ma(),M({type:"hide",index:e,tileType:n}),(n===0||n===1)&&(F[n]=Math.min(na[n],F[n]+1),nn(n)))}function nn(e){const a=document.getElementById(`c${e}`);a&&(a.textContent=F[e])}function kn(e){if(F[e]>0)return;Ge=!0,Ua(e),he(C[e]),M({type:"win",team:e});const a=document.createElement("div");a.className="win-overlay";const n=e===0?"EQUIPO 1":"EQUIPO 2";a.innerHTML=`
    <div class="win-text" style="color:${C[e]}">${n} GANA!</div>
    <button class="btn" id="win-new-btn">NUEVA PARTIDA</button>
  `,$.appendChild(a),document.getElementById("win-new-btn").addEventListener("click",()=>{Aa(),Ze($)})}function Qa(e,a,n){if(be=[],!a){e.innerHTML=`
      <div class="scene">
        <h1 class="title">CODIGO</h1>
        <p class="label" style="opacity:0.6">Esperando tablero…</p>
      </div>
    `;return}const o=C[a.isTeamOneFirst?0:1];e.innerHTML=`
    <div class="scene board-scene">
      <div class="team-banner" style="background:${o}22; border-bottom:3px solid ${o}">
  ...
  `;const i=document.getElementById("spec-board");a.tiles.forEach((s,l)=>{var r;const t=document.createElement("div");t.className="tile tile-neutral",t.innerHTML=`<span class="tile-word">${(r=a.words[l])!==null&&r!==void 0?r:""}</span>`,i.appendChild(t),be.push(t)}),requestAnimationFrame(()=>be.forEach(rn)),n.forEach((s,l)=>{s&&on(l,s.color)})}function on(e,a){const n=be[e];n&&(n.style.background=a,n.classList.remove("tile-neutral"),n.classList.add("revealed"))}function Bn(e){const a=be[e];a&&(a.style.background="",a.classList.remove("revealed"),a.classList.add("tile-neutral"))}function Rn(e,a){const n=C[e],o=e===0?"EQUIPO 1":"EQUIPO 2";he(n);const i=document.createElement("div");i.className="win-overlay",i.innerHTML=`<div class="win-text" style="color:${n}">${o} GANA!</div>`,a.appendChild(i)}function rn(e){const a=e.querySelector(".tile-word");if(!a)return;let n=parseFloat(getComputedStyle(a).fontSize);for(;a.scrollWidth>a.clientWidth+1&&n>9;)n-=.5,a.style.fontSize=`${n}px`;a.scrollWidth>a.clientWidth+1&&(a.style.letterSpacing="0"),a.scrollWidth>a.clientWidth+1&&(a.style.whiteSpace="normal")}function sn(e){const a=[...e];for(let n=a.length-1;n>0;n--){const o=Math.floor(Math.random()*(n+1));[a[n],a[o]]=[a[o],a[n]]}return a}function xn(e,a){Ce=e,ra=a,v=new Map,A=-1,N="lobby",S&&(clearInterval(S),S=null),L=sn(Ne).slice(0,ia);const n=Qe();ca=n,e.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("start-btn").focus(),f("connected",()=>{}),f("peer-left",o=>{if(N==="lobby"){for(const[i,s]of v)if(s.conn===o){v.delete(i);break}Pa()}else{for(const i of v.values())if(i.conn===o){i.conn=null;break}Xe()}}),f("message",(o,i)=>{o.type==="trivia-join"&&Gn(i,o),o.type==="trivia-answer"&&jn(o)}),document.getElementById("start-btn").addEventListener("click",Nn),ha(n)}function Gn(e,a){const n=a.clientId;if(!n)return;const o=v.get(n);if(o){o.conn=e,o.name=a.name||o.name,tn(e,o);return}if(N!=="lobby"){v.set(n,{name:a.name,score:0,answered:!1,conn:e}),tn(e,v.get(n)),La();return}v.set(n,{name:a.name,score:0,answered:!1,conn:e}),p(e,{type:"trivia-waiting"}),La(),Pa()}function tn(e,a){if(N==="lobby"){p(e,{type:"trivia-waiting"}),Pa();return}if(N==="question"){const n=L[A],o=Date.now()-la,i=Math.max(0,da-o);p(e,{type:"trivia-question",index:A,total:L.length,q:n.q,options:n.options,answer:n.answer,remainingMs:i,myScore:a.score,alreadyAnswered:a.answered}),fe&&p(e,{type:"trivia-reveal",correctIndex:n.answer,scores:$n()}),Xe();return}if(N==="interlude"){p(e,{type:"trivia-interlude",scores:sa,myScore:a.score});return}if(N==="end"){p(e,{type:"trivia-end",scores:ta});return}}function $n(){return[...v.values()].map(e=>({name:e.name,score:e.score}))}function Pa(){const e=document.getElementById("player-list");if(!e)return;e.innerHTML=[...v.values()].map(o=>`<span class="player-chip">${o.name}</span>`).join("");const a=document.getElementById("start-btn");if(!a)return;const n=a.disabled;a.disabled=v.size===0,n&&!a.disabled&&a.focus()}function Nn(){v.forEach(e=>{e.score=0}),te({type:"trivia-start",total:L.length}),A=-1,ka()}function ka(){if(A++,fe=!1,A>=L.length){cn();return}v.forEach(a=>{a.answered=!1}),N="question",la=Date.now();const e=L[A];qn(),zn(e,A),te({type:"trivia-question",index:A,total:L.length,q:e.q,options:e.options,answer:e.answer,remainingMs:da}),On()}function zn(e,a){const n="background:rgba(46,95,168,0.12);";Ce.innerHTML=`
    <div class="scene board-scene">
      <div class="team-banner" style="${n}border-bottom:3px solid var(--accent);justify-content:space-between">
        ...
        <span class="trivia-tv-timer" id="tv-timer">${ze}</span>
      </div>
        ...
        <div class="trivia-tv-options">
          ${e.options.map((o,i)=>`
            <div class="trivia-tv-option" id="opt-${i}">
              <span class="trivia-opt-label">${Ha[i]}</span>
  ...
  `,Xe()}function On(){let e=ze;S=setInterval(()=>{e--;const a=document.getElementById("tv-timer");a&&(a.textContent=e,a.className="trivia-tv-timer"+(e<=3?" timer-urgent":"")),e>0&&e<=3&&Sa(),e<=0&&(clearInterval(S),S=null,Ka(),ln())},1e3)}function jn(e){const a=v.get(e.clientId);if(!a||a.answered||e.questionIndex!==A)return;a.answered=!0;const n=e.answerIndex===L[A].answer;n&&a.score++,a.conn&&p(a.conn,{type:"trivia-feedback",correct:n}),Xe(),[...v.values()].every(o=>o.answered)&&(clearInterval(S),S=null,ln())}function Xe(){const e=document.getElementById("tv-players");e&&(e.innerHTML=[...v.values()].map(a=>`<span class="player-dot ${a.answered?"dot-answered":""}">${a.name}</span>`).join(""))}function ln(){if(fe)return;fe=!0;const e=L[A].answer;document.querySelectorAll(".trivia-tv-option").forEach((n,o)=>{n.classList.add(o===e?"opt-correct":"opt-wrong")}),Ke();const a=[...v.values()].map(n=>({name:n.name,score:n.score}));te({type:"trivia-reveal",correctIndex:e,scores:a}),setTimeout(()=>Dn(a),2500)}function Dn(e){const a=A<L.length-1,n=[...e].sort((o,i)=>i.score-o.score);if(N="interlude",sa=n,Ce.innerHTML=`
    <div class="scene">
  ...
  `,a){te({type:"trivia-interlude",scores:n});let o=3;S=setInterval(()=>{o--,Za();const i=document.getElementById("interlude-count");i&&(i.textContent=o),o<=0&&(clearInterval(S),S=null,ka())},1e3)}else setTimeout(cn,1500)}function cn(){var e,a;const n=[...v.values()].map(r=>({name:r.name,score:r.score})).sort((r,t)=>t.score-r.score);N="end",ta=n;const o=(e=(a=n[0])===null||a===void 0?void 0:a.score)!==null&&e!==void 0?e:0,i=n.filter(r=>r.score===o&&o>0),l=i.length>1?"EMPATE":i.length?"GANADOR":"FIN";Ya(),he(n[0]?"#2e5fa8":"#a78bfa"),Ce.innerHTML=`
    <div class="scene">
      <h1 class="title" style="font-size:2rem;margin-bottom:4px">${l}</h1>
      ${i.length?i.map(r=>`<div class="winner-name">${r.name}</div>`).join(""):'<div class="winner-name">—</div>'}
      <div class="trivia-scoreboard" style="margin-top:24px">
        ${n.map((r,t)=>`
          <div class="score-row">
            <span class="score-rank">${t+1}</span>
            <span class="score-name">${r.name}</span>
            <span class="score-pts">${r.score} / ${L.length}</span>
          </div>
        `).join("")}
      </div>
      <div class="end-join-block">
        <span class="end-join-label">¿Quieres jugar? Únete con</span>
        <span class="end-join-code">${ca}</span>
      </div>
  ...
  `,te({type:"trivia-end",scores:n}),document.getElementById("again-btn").focus(),document.getElementById("again-btn").onclick=()=>Fn(),document.getElementById("menu-btn").onclick=()=>{var r;return(r=ra)===null||r===void 0?void 0:r()}}function Fn(){fe=!1,S&&(clearInterval(S),S=null),L=sn(Ne).slice(0,ia),v.forEach(e=>{e.score=0,e.answered=!1}),te({type:"trivia-start",total:L.length}),A=-1,ka()}function Hn(e,a){le=e,ua=a,ne=0,je=0,ae=!1,we(),Jn(),Vn(e)}function Jn(){if(pa)return;pa=!0;const e=()=>{if(document.visibilityState!=="visible"||!Oe||!z)return;const a=Ta();a?.mode==="trivia"&&(Pe()||dn(Oe,z))};document.addEventListener("visibilitychange",e),window.addEventListener("focus",e),window.addEventListener("online",e)}function we(){ce&&(clearInterval(ce),ce=null),de&&(clearInterval(de),de=null)}function Vn(e){e.innerHTML=`
    <div class="scene">
      <h1 class="title">TRIVIA</h1>
  ...
  `;const a=()=>{const n=document.getElementById("code-input").value.trim(),o=document.getElementById("name-input").value.trim(),i=document.getElementById("status");if(n.length!==4){i.textContent="Ingresa el código de 4 dígitos";return}if(!o){i.textContent="Ingresa tu nombre";return}document.getElementById("join-btn").disabled=!0,i.textContent="Conectando…",dn(n,o)};document.getElementById("join-btn").onclick=a,document.getElementById("name-input").addEventListener("keydown",n=>{n.key==="Enter"&&a()})}function dn(e,a){Oe=e,z=a,Ia({mode:"trivia",code:e,name:a}),Se(),f("connected",()=>{M({type:"trivia-join",name:z,clientId:_e()})}),f("message",n=>{n.type==="trivia-waiting"&&un(le),n.type==="trivia-start"&&(je=n.total,ne=0,un(le)),n.type==="trivia-question"&&Wn(le,n),n.type==="trivia-feedback"&&Un(n.correct),n.type==="trivia-reveal"&&Kn(n.correctIndex),n.type==="trivia-interlude"&&_n(le,n),n.type==="trivia-end"&&Yn(le,n.scores)}),f("error",n=>{const o=document.getElementById("status");o&&(o.textContent=n.type==="peer-unavailable"?"❌ Código incorrecto — revisa el televisor":`❌ ${n.type}`);const i=document.getElementById("join-btn");i&&(i.disabled=!1)}),ya(e)}function un(e){we(),e.innerHTML=`
    <div class="scene">
      <h1 class="title">TRIVIA</h1>
      <p class="label">¡Conectado como <strong style="color:#fff">${z}</strong>!</p>
      <p class="label" style="opacity:0.45;margin-top:4px">Esperando que el televisor empiece…</p>
    </div>
  `}function Wn(e,a){ae=!!a.alreadyAnswered,Fe=-1,De=a.answer,typeof a.myScore=="number"&&(ne=a.myScore),we();const n="background:rgba(46,95,168,0.12);";e.innerHTML=`
    <div class="scene board-scene">
      <div class="team-banner trivia-safe-top" style="${n}border-bottom:3px solid var(--accent);justify-content:space-between">
        ...
        <span class="trivia-phone-score" id="phone-score">${ne} pts</span>
      ...
      <div class="trivia-phone-body">
        ...
        <div class="trivia-phone-options">
          ${a.options.map((r,t)=>`
            <button class="trivia-phone-option" data-idx="${t}">${r}</button>
          `).join("")}
        </div>
        <div id="phone-status" class="trivia-phone-status"></div>
      </div>
    </div>
  `,document.querySelectorAll(".trivia-phone-option").forEach(r=>{if(ae){r.disabled=!0;return}r.addEventListener("click",()=>{if(ae)return;ae=!0,Le(),we();const t=parseInt(r.dataset.idx);Fe=t,M({type:"trivia-answer",answerIndex:t,questionIndex:a.index,clientId:_e()}),document.querySelectorAll(".trivia-phone-option").forEach(j=>{j.disabled=!0}),r.style.outline="4px solid white",r.style.outlineOffset="-4px",document.getElementById("phone-status").textContent="¡Respuesta enviada!"})});const o=document.getElementById("phone-score");o&&(o.textContent=`${ne} pts`),ae&&(document.getElementById("phone-status").textContent="¡Respuesta enviada!");const i=typeof a.remainingMs=="number"?a.remainingMs:15e3;let s=Math.max(0,Math.ceil(i/1e3));const l=document.getElementById("phone-timer");l&&(l.textContent=s),ce=setInterval(()=>{s--,l&&(l.textContent=s,s<=3&&(l.className="trivia-phone-timer timer-urgent")),s<=0&&(clearInterval(ce),ce=null)},1e3)}function Un(e){e&&ne++;const a=document.getElementById("phone-status");a&&(a.textContent=e?"✓ ¡Correcto!":"✗ Incorrecto",a.style.color=e?"#4ade80":"#f87171");const n=document.getElementById("phone-score");n&&(n.textContent=`${ne} pts`),document.querySelectorAll(".trivia-phone-option").forEach(o=>{const i=parseInt(o.dataset.idx);o.style.outline="",o.style.outlineOffset="",i===De?o.classList.add("opt-correct"):i===Fe?o.classList.add("opt-mine-wrong"):o.classList.add("opt-wrong")}),e?Ke():_a()}function Kn(e){if(ae)return;De=e,document.querySelectorAll(".trivia-phone-option").forEach(n=>{const o=parseInt(n.dataset.idx);n.disabled=!0,o===e?n.classList.add("opt-correct"):n.classList.add("opt-wrong")});const a=document.getElementById("phone-status");a&&(a.textContent="⏱ Tiempo agotado",a.style.color="#f87171")}function _n(e,a){we();const n=a.scores;e.innerHTML=`
    <div class="scene">
      <h2 class="trivia-interlude-title">PUNTAJES</h2>
      <div class="trivia-scoreboard">
        ${n.map((i,s)=>`
          <div class="score-row ${i.name===z?"score-row-me":""}">
  ...
  `;let o=3;de=setInterval(()=>{o--,Za();const i=document.getElementById("phone-interlude-count");i&&(i.textContent=o),o<=0&&(clearInterval(de),de=null)},1e3)}function Yn(e,a){var n,o,i;we();const s=a.find(q=>q.name===z),l=a.findIndex(q=>q.name===z)+1,r=(n=(o=a[0])===null||o===void 0?void 0:o.score)!==null&&n!==void 0?n:0,t=a.filter(q=>q.score===r&&r>0),j=t.some(q=>q.name===z),Ga=t.length>1;j&&he("#2e5fa8");let Ie;j&&Ga?Ie='<h1 class="title" style="font-size:2rem">🏆 ¡EMPATE!</h1>':j?Ie='<h1 class="title" style="font-size:2rem">🏆 ¡GANASTE!</h1>':Ie='<h1 class="title" style="font-size:1.6rem;opacity:0.7">FIN</h1>';let $a="";!j&&t.length&&($a=`
      <div style="text-align:center;margin-top:-4px">
        <div style="font-size:0.85rem;letter-spacing:0.1em;color:rgba(255,255,255,0.45);font-weight:700">${Ga?"GANADORES":"GANADOR"}</div>
        <div class="winner-name" style="font-size:clamp(1.4rem,5vw,2.4rem);margin-top:2px">
          ${t.map(Na=>Na.name).join(" · ")}
        </div>
      </div>
    `),e.innerHTML=`
    <div class="scene">
      ...
      <div class="trivia-my-score">
        <div class="trivia-my-score-num">${(i=s?.score)!==null&&i!==void 0?i:0}</div>
        <div class="trivia-my-score-label">de ${je} correctas</div>
        <div class="trivia-my-score-rank">Puesto ${l} de ${a.length}</div>
      </div>
      <div class="trivia-scoreboard">
        ${a.map((q,Na)=>`
          <div class="score-row ${q.name===z?"score-row-me":""}">
            <span class="score-rank">${Na+1}</span>
            <span class="score-name">${q.name}</span>
            <span class="score-pts">${q.score}</span>
          </div>
        `).join("")}
      </div>
      <button class="btn" id="menu-btn" style="margin-top:16px">MENÚ PRINCIPAL</button>
    </div>
  `,document.getElementById("menu-btn").onclick=()=>{var q;Ye(),(q=ua)===null||q===void 0||q()}}function Zn(e,a){_=e,Ee=a,pn(),R=null,Me=null,c="lobby",Y=Qe(),bn(),f("connected",()=>{}),f("peer-left",n=>{n===R&&(R=null,E&&(clearInterval(E),E=null),mo())}),f("message",(n,o)=>{if(n.type==="mimica-hello")return Xn(o,n.clientId);if(n.type==="mimica-setup-teams")return eo(n.count);if(n.type==="mimica-begin-turn")return ao();if(n.type==="mimica-correct")return no();if(n.type==="mimica-skip")return oo();if(n.type==="mimica-next-team")return io();if(n.type==="mimica-restart")return ro()}),ha(Y)}function pn(){E&&(clearInterval(E),E=null),Ve="",ve=new Set,m=[],g=0,O=0,x=0}function Xn(e,a){var n;const o=a&&a===Me,i=!((n=R)!==null&&n!==void 0&&n.open);o||i?(R=e,Me=a||Me,La(),c==="lobby"&&(c="setup"),c==="playing"&&!E&&mn(),Z(),pe()):p(e,{type:"mimica-rejected",reason:"captain-taken"})}function Z(){R&&(c==="setup"?p(R,{type:"mimica-setup-needed"}):c==="turn-ready"?p(R,{type:"mimica-turn-ready",teams:m,currentTeamIdx:g}):c==="playing"?p(R,{type:"mimica-word",word:Ve,remaining:x,aciertosThisTurn:O,teams:m,currentTeamIdx:g}):c==="turn-end"?p(R,{type:"mimica-turn-end",teams:m,currentTeamIdx:g,aciertosThisTurn:O,hasMore:g<m.length-1}):c==="game-end"&&p(R,{type:"mimica-game-end",teams:m}))}function eo(e){if(c!=="setup")return;const a=Math.max(2,Math.min(6,Number(e)||0));m=Array.from({length:a},(n,o)=>({name:`Equipo ${o+1}`,score:0})),g=0,O=0,c="turn-ready",Z(),pe()}function ao(){c==="turn-ready"&&(O=0,x=Ja,c="playing",Ba(),mn(),Z(),pe())}function no(){c==="playing"&&(O++,m[g].score++,Ke(),Ba(),Z(),fn())}function oo(){c==="playing"&&(Ba(),Z(),fn())}function io(){if(c==="turn-end"){if(g>=m.length-1){so();return}g++,O=0,c="turn-ready",Z(),pe()}}function ro(){c==="game-end"&&(pn(),c="setup",Z(),pe())}function Ba(){ve.size>=He.length&&ve.clear();let e;do e=He[Math.floor(Math.random()*He.length)];while(ve.has(e));ve.add(e),Ve=e}function mn(){E&&clearInterval(E),E=setInterval(()=>{x--;const e=document.getElementById("mimica-timer");e&&(e.textContent=x,e.className="mimica-timer"+(x<=5?" timer-urgent":"")),x>0&&x<=5&&Sa(),x<=0&&(clearInterval(E),E=null,Ka(),c="turn-end",Z(),pe())},1e3)}function so(){var e;c="game-end",E&&(clearInterval(E),E=null),Ya();const a=[...m].sort((n,o)=>o.score-n.score);he((e=Je[m.indexOf(a[0])])!==null&&e!==void 0?e:"#2e5fa8"),Z(),pe()}function pe(){if(c==="lobby")return bn();if(c==="setup")return to();if(c==="turn-ready")return lo();if(c==="playing")return co();if(c==="turn-end")return uo();if(c==="game-end")return po()}function ie(e){return Je[e%Je.length]}function gn(e=-1){return`
    <div class="mimica-scoreboard">
      ${m.map((a,n)=>`
        <div class="mimica-score-row ${n===e?"mimica-score-row-current":""}"
             style="--team-color:${ie(n)}">
          <span class="mimica-score-dot"></span>
          <span class="mimica-score-name">${a.name}</span>
          <span class="mimica-score-pts">${a.score}</span>
        </div>
      `).join("")}
    </div>
  `}function bn(){_.innerHTML=`
    <div class="scene">
      <h1 class="title">MÍMICA</h1>
      <p class="label">Conecta tu móvil con este código:</p>
      <div class="room-code">${Y}</div>
  ...
  `,document.getElementById("menu-btn").onclick=()=>{var e;return(e=Ee)===null||e===void 0?void 0:e()}}function to(){_.innerHTML=`
    <div class="scene">
      <h1 class="title">MÍMICA</h1>
      ...
      <div class="end-join-block" style="margin-top:32px">
        ...
        <span class="end-join-code">${Y}</span>
      </div>
    </div>
  `}function lo(){const e=m[g];_.innerHTML=`
    <div class="scene mimica-scene">
      <div class="mimica-top">
        <span class="mimica-code">${Y}</span>
        <span class="mimica-progress">Turno ${g+1} / ${m.length}</span>
      </div>
      <div class="mimica-ready-center">
        <div class="mimica-ready-label">TURNO DEL</div>
        <div class="mimica-ready-team" style="color:${ie(g)}">${e.name}</div>
        <div class="mimica-ready-help">Pasa el móvil al capitán de este equipo</div>
      </div>
      <div class="mimica-foot">${gn(g)}</div>
    </div>
  `}function co(){const e=m[g];_.innerHTML=`
    <div class="scene mimica-scene">
      <div class="mimica-top">
        <span class="mimica-team-tag" style="background:${ie(g)}22;color:${ie(g)}">${e.name}</span>
      ...
      <div class="mimica-timer-wrap">
        ...
        <div class="mimica-timer${x<=5?" timer-urgent":""}" id="mimica-timer">${x}</div>
      </div>
      <div class="mimica-foot">¡A actuar! El capitán ve la palabra.</div>
    </div>
  `}function fn(){const e=document.getElementById("mimica-aciertos");e&&(e.textContent=O)}function uo(){const e=m[g],a=g>=m.length-1;_.innerHTML=`
    <div class="scene mimica-scene">
      <div class="mimica-top">
        <span class="mimica-code">${Y}</span>
        <span class="mimica-progress">Turno ${g+1} / ${m.length}</span>
      ...
      <div class="mimica-turnend-center">
        ...
        <div class="mimica-turnend-team" style="color:${ie(g)}">${e.name}</div>
  ...
  `}function po(){var e,a;const n=[...m].sort((r,t)=>t.score-r.score),o=(e=(a=n[0])===null||a===void 0?void 0:a.score)!==null&&e!==void 0?e:0,i=n.filter(r=>r.score===o&&o>0),l=i.length>1?"EMPATE":i.length?"GANA":"FIN";_.innerHTML=`
    <div class="scene">
      <h1 class="title" style="font-size:2rem;margin-bottom:4px">${l}</h1>
      ${i.length?i.map(r=>`<div class="winner-name" style="color:${ie(m.indexOf(r))}">${r.name}</div>`).join(""):'<div class="winner-name">—</div>'}
      <div class="mimica-scoreboard" style="margin-top:24px;max-width:520px;width:100%">
        ${n.map(r=>{const t=m.indexOf(r);return`
          <div class="mimica-score-row" style="--team-color:${ie(t)}">
            <span class="mimica-score-dot"></span>
            <span class="mimica-score-name">${r.name}</span>
            <span class="mimica-score-pts">${r.score}</span>
          </div>`}).join("")}
      </div>
      <div class="end-join-block">
        <span class="end-join-label">¿Quieres jugar? Únete con</span>
  ...
  `,document.getElementById("menu-btn").onclick=()=>{var r;return(r=Ee)===null||r===void 0?void 0:r()}}function mo(){_.innerHTML=`
    <div class="scene">
      <h1 class="title" style="font-size:1.8rem">CAPITÁN DESCONECTADO</h1>
      <p class="label">Esperando reconexión…</p>
      <div class="room-code" style="font-size:clamp(3rem,12vw,6rem)">${Y}</div>
      ${m.length?`<div class="mimica-scoreboard" style="margin-top:16px;max-width:420px;width:100%">
        ${m.map((e,a)=>`
          <div class="mimica-score-row" style="--team-color:${ie(a)}">
            <span class="mimica-score-dot"></span>
            <span class="mimica-score-name">${e.name}</span>
  ...
  `,document.getElementById("menu-btn").onclick=()=>{var e;return(e=Ee)===null||e===void 0?void 0:e()}}function go(e,a){oe=e,We=a,bo(),fo(e)}function bo(){if(ga)return;ga=!0;const e=()=>{if(document.visibilityState!=="visible"||!Ue)return;const a=Ta();a?.mode==="mimica"&&(Pe()||vn(Ue))};document.addEventListener("visibilitychange",e),window.addEventListener("focus",e),window.addEventListener("online",e)}function J(e){return ma[e%ma.length]}function fo(e){e.innerHTML=`
    <div class="scene">
      <h1 class="title">MÍMICA</h1>
  ...
  `;const a=document.getElementById("code-input"),n=document.getElementById("connect-btn"),o=document.getElementById("status"),i=()=>{const s=a.value.trim();if(s.length!==4){o.textContent="Ingresa el código de 4 dígitos";return}n.disabled=!0,o.textContent="Conectando…",vn(s)};n.onclick=i,a.addEventListener("keydown",s=>{s.key==="Enter"&&i()})}function vn(e){Ue=e,Ia({mode:"mimica",code:e}),Se(),re(),f("connected",()=>{M({type:"mimica-hello",clientId:_e()})}),f("message",a=>{if(a.type==="mimica-setup-needed")return vo();if(a.type==="mimica-turn-ready")return ho(a);if(a.type==="mimica-word")return wo(a);if(a.type==="mimica-turn-end")return Co(a);if(a.type==="mimica-game-end")return Eo(a);if(a.type==="mimica-rejected")return Mo()}),f("error",a=>{const n=document.getElementById("status");n&&(n.textContent=a.type==="peer-unavailable"?"❌ Código incorrecto — revisa el televisor":`❌ ${a.type}`);const o=document.getElementById("connect-btn");o&&(o.disabled=!1)}),ya(e)}function vo(){re(),oe.innerHTML=`
    <div class="scene">
  ...
  `,document.querySelectorAll(".mimica-setup-btn").forEach(e=>{e.onclick=()=>{Le(),M({type:"mimica-setup-teams",count:parseInt(e.dataset.n)})}})}function ho(e){re(),Q=e.teams,I=e.currentTeamIdx;const a=Q[I];oe.innerHTML=`
    <div class="scene">
  ...
  `;const n=document.getElementById("begin-btn");n.focus(),n.onclick=()=>{Le(),M({type:"mimica-begin-turn"})}}function wo(e){ba=e.word,H=e.remaining,ue=e.aciertosThisTurn,Q=e.teams,I=e.currentTeamIdx,yo(),qo()}function yo(){const e=Q[I];oe.innerHTML=`
    <div class="scene mimica-phone-scene">
      <div class="mimica-phone-top" style="border-bottom-color:${J(I)}55">
        ...
        <span class="mimica-phone-aciertos">Aciertos: <strong id="phone-aciertos">${ue}</strong></span>
        <span class="mimica-phone-timer${H<=5?" timer-urgent":""}" id="mimica-phone-timer">${H}s</span>
      </div>
      <div class="mimica-word-wrap">
        <div class="mimica-word">${ba}</div>
      </div>
  ...
  `,document.getElementById("correct-btn").onclick=()=>{Ke(),ue++;const a=document.getElementById("phone-aciertos");a&&(a.textContent=ue),M({type:"mimica-correct"})},document.getElementById("pass-btn").onclick=()=>{_a(),M({type:"mimica-skip"})}}function qo(){re(),Ae=setInterval(()=>{H--;const e=document.getElementById("mimica-phone-timer");e&&(e.textContent=`${H}s`,H<=5&&e.classList.add("timer-urgent")),H>0&&H<=5&&Sa(),H<=0&&re()},1e3)}function re(){Ae&&(clearInterval(Ae),Ae=null)}function Co(e){re(),Q=e.teams,I=e.currentTeamIdx,ue=e.aciertosThisTurn;const a=Q[I],n=!e.hasMore;oe.innerHTML=`
    <div class="scene">
      ...
      <div class="mimica-turnend-stat" style="font-size:clamp(2.8rem,12vw,5rem);font-weight:900;line-height:1">+${ue}</div>
      <p class="label" style="margin-top:-4px;opacity:0.55">aciertos esta ronda</p>
      <div class="mimica-mini-scoreboard">
        ${Q.map((i,s)=>`
          <div class="mimica-mini-row ${s===I?"mimica-mini-row-current":""}" style="--team-color:${J(s)}">
            <span class="mimica-score-dot"></span>
  ...
  `;const o=document.getElementById("next-btn");o.focus(),o.onclick=()=>{Le(),M({type:"mimica-next-team"})}}function Eo(e){var a,n;re(),Q=e.teams;const o=[...Q].sort((t,j)=>j.score-t.score),i=(a=(n=o[0])===null||n===void 0?void 0:n.score)!==null&&a!==void 0?a:0,s=o.filter(t=>t.score===i&&i>0),r=s.length>1?"🏆 ¡EMPATE!":s.length?"🏆 ¡GANADOR!":"FIN";oe.innerHTML=`
    <div class="scene">
      <h1 class="title" style="font-size:2rem;margin-bottom:8px">${r}</h1>
      ${s.length?s.map(t=>`<div class="winner-name" style="color:${J(Q.indexOf(t))}">${t.name}</div>`).join(""):'<div class="winner-name">—</div>'}
      <div class="mimica-mini-scoreboard" style="margin-top:24px">
        ${o.map(t=>{const j=Q.indexOf(t);return`
          <div class="mimica-mini-row" style="--team-color:${J(j)}">
            <span class="mimica-score-dot"></span>
  ...
  `,document.getElementById("again-btn").focus(),document.getElementById("again-btn").onclick=()=>{Le(),M({type:"mimica-restart"})},document.getElementById("menu-btn").onclick=()=>{var t;Ye(),(t=We)===null||t===void 0||t()}}function Mo(){re(),oe.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("back-btn").onclick=()=>{var e;Ye(),(e=We)===null||e===void 0||e()}}function Ao(e,a){n();function n(){const o=Wa(),i=C[o.isTeamOneFirst?0:1];e.innerHTML=`
      <div class="scene board-scene">
    ...
    `;const s=document.getElementById("board");o.tiles.forEach(l=>{const r=document.createElement("div");r.className="tile",r.dataset.type=l,r.style.background=C[l],r.addEventListener("click",()=>{const t=!r.classList.contains("checked");r.classList.toggle("checked",t),t?(Ca(r),Ea(l)):Ma()}),s.appendChild(r)}),document.getElementById("back-btn").onclick=a,document.getElementById("new-map-btn").onclick=()=>{confirm("¿Generar un nuevo mapa?")&&(Aa(),n())}}}function So(){fa||(fa=!0,document.addEventListener("keydown",e=>{if(e.key!=="ArrowDown"&&e.key!=="ArrowUp")return;const a=[...document.querySelectorAll(".btn")];if(!a.length)return;const n=a.indexOf(document.activeElement);e.key==="ArrowDown"&&a[Math.min(n+1,a.length-1)].focus(),e.key==="ArrowUp"&&a[Math.max(n-1,0)].focus(),e.preventDefault()}))}function Ra(e){Se(),Ye(),So(),e.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("cs-btn").focus(),document.getElementById("cs-btn").onclick=()=>xa(e,"cs"),document.getElementById("trivia-btn").onclick=()=>xa(e,"trivia"),document.getElementById("mimica-btn").onclick=()=>xa(e,"mimica"),document.getElementById("mapa-btn").onclick=()=>Ao(e,()=>Ra(e))}function xa(e,a){Se();const o={cs:"CÓDIGO SECRETO",trivia:"TRIVIA",mimica:"MÍMICA"}[a];e.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("tv-btn").focus();const i=()=>Ra(e);document.getElementById("tv-btn").onclick=()=>{if(a==="cs")return Cn(e);if(a==="trivia")return xn(e,i);if(a==="mimica")return Zn(e,i)},document.getElementById("phone-btn").onclick=()=>{if(a==="cs")return Tn(e);if(a==="trivia")return Hn(e,i);if(a==="mimica")return go(e,i)},document.getElementById("back-btn").onclick=i}return{setters:[],execute:function(){b="modulepreload",h=function(e){return"/"+e},X={},se=function(a,n,o){let i=Promise.resolve();function s(l){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=l,window.dispatchEvent(r),!r.defaultPrevented)throw l}return i.then(l=>{for(const r of l||[])r.status==="rejected"&&s(r.reason);return a().catch(s)})},V="codigo-",D=null,w=null,P=null,me=[],Te=new Map,T=(e,...a)=>{var n;return(n=Te.get(e))===null||n===void 0?void 0:n(...a)},f=(e,a)=>Te.set(e,a),Qe=()=>String(Math.floor(1e3+Math.random()*9e3)),M=e=>{var a;return((a=P)===null||a===void 0?void 0:a.open)&&P.send(e)},p=(e,a)=>e?.open&&e.send(a),te=e=>me.filter(a=>a.open).forEach(a=>a.send(e)),Pe=()=>{var e;return!!((e=P)!==null&&e!==void 0&&e.open)},ja=`
abogado
aceite
áfrica
agente
