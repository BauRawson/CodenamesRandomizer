(function(){function Ia(p,g){var v=Object.keys(p);if(Object.getOwnPropertySymbols){var w=Object.getOwnPropertySymbols(p);g&&(w=w.filter(function(Q){return Object.getOwnPropertyDescriptor(p,Q).enumerable})),v.push.apply(v,w)}return v}function fe(p){for(var g=1;g<arguments.length;g++){var v=arguments[g]!=null?arguments[g]:{};g%2?Ia(Object(v),!0).forEach(function(w){ln(p,w,v[w])}):Object.getOwnPropertyDescriptors?Object.defineProperties(p,Object.getOwnPropertyDescriptors(v)):Ia(Object(v)).forEach(function(w){Object.defineProperty(p,w,Object.getOwnPropertyDescriptor(v,w))})}return p}function ln(p,g,v){return(g=cn(g))in p?Object.defineProperty(p,g,{value:v,enumerable:!0,configurable:!0,writable:!0}):p[g]=v,p}function cn(p){var g=dn(p,"string");return typeof g=="symbol"?g:g+""}function dn(p,g){if(typeof p!="object"||!p)return p;var v=p[Symbol.toPrimitive];if(v!==void 0){var w=v.call(p,g||"default");if(typeof w!="object")return w;throw new TypeError("@@toPrimitive must return a primitive value.")}return(g==="string"?String:Number)(p)}System.register([],function(p,g){"use strict";var v,w,Q,b,h,le,ce,Me,M,d,ne,Se,Ta,Qa,q,Ae,ka,de,H,Le,k,ve,P,J,_,Ke,Ie,x,V,Te,z,_e,Qe,G,ue,ke,Ye,Pe,Be,Ze,Pa,he,Xe,f,S,pe,A,L,$,ea,aa,na,oa,ia,oe,ra,N,Re,Y,Z,xe,ie,re,Ge,$e,sa,Ne,Ba,Oe,W,we,B,ye,ze,me,R,C,u,m,O,c,U,ta,X,De,je,la,qe,D,ca,se,T,I,da;function Ra(e){h=new WebSocket(v),h.addEventListener("open",e),h.addEventListener("error",()=>Q("error",{type:"network"})),h.addEventListener("close",()=>{le==="phone"&&Q("disconnected")}),h.addEventListener("message",a=>{let n;try{n=JSON.parse(a.data)}catch{return}un(n)})}function un(e){switch(e.type){case"ready":break;case"peer-joined":{const a={id:e.peerId,open:!0};ce.set(e.peerId,a),Q("connected",a);break}case"from-peer":{const a=ce.get(e.peerId);a&&Q("message",e.payload,a);break}case"peer-left":{const a=ce.get(e.peerId);a&&(a.open=!1,ce.delete(e.peerId),Q("peer-left",a));break}case"joined":Q("connected");break;case"from-host":Q("message",e.payload);break;case"host-left":Q("disconnected");break;case"error":Q("error",{type:e.error});break}}function ua(e){le="tv",Ra(()=>h.send(JSON.stringify({type:"host",code:e})))}function pa(e){le="phone",Ra(()=>h.send(JSON.stringify({type:"join",code:e})))}function Ce(){h&&(h.close(),h=null),le=null,ce.clear(),w.clear()}function xa(){const e=Math.random()<.5,a=[...Array(e?9:8).fill(0),...Array(e?8:9).fill(1),...Array(7).fill(2),...Array(1).fill(3)];for(let i=a.length-1;i>0;i--){const r=Math.floor(Math.random()*(i+1));[a[i],a[r]]=[a[r],a[i]]}const n=[...Qa];for(let i=n.length-1;i>0;i--){const r=Math.floor(Math.random()*(i+1));[n[i],n[r]]=[n[r],n[i]]}const o=n.slice(0,25);return{tiles:a,isTeamOneFirst:e,words:o}}function ma(e){e.animate&&e.animate([{transform:"scale(0.88)",opacity:.6},{transform:"scale(1.06)",opacity:1},{transform:"scale(1)",opacity:1}],{duration:240,easing:"ease-out",fill:"none"})}function ge(e){const a=document.createElement("canvas");a.style.cssText="position:fixed;top:0;right:0;bottom:0;left:0;inset:0;width:100%;height:100%;pointer-events:none;z-index:999",document.body.appendChild(a);const n=a.getContext("2d");a.width=window.innerWidth,a.height=window.innerHeight;const i=Array.from({length:120},()=>({x:Math.random()*a.width,y:-20-Math.random()*80,vx:(Math.random()-.5)*4,vy:2+Math.random()*4,rot:Math.random()*Math.PI*2,vrot:(Math.random()-.5)*.2,w:8+Math.random()*8,h:5+Math.random()*5,color:Math.random()<.6?e:"#fbb954",alpha:1}));let r;const l=()=>{n.clearRect(0,0,a.width,a.height);let s=!1;for(const t of i)t.x+=t.vx,t.y+=t.vy,t.vy+=.08,t.rot+=t.vrot,t.y>a.height*.85&&(t.alpha-=.03),!(t.alpha<=0)&&(s=!0,n.save(),n.globalAlpha=t.alpha,n.translate(t.x,t.y),n.rotate(t.rot),n.fillStyle=t.color,n.fillRect(-t.w/2,-t.h/2,t.w,t.h),n.restore());s?r=requestAnimationFrame(l):a.remove()};r=requestAnimationFrame(l),setTimeout(()=>{cancelAnimationFrame(r),a.remove()},4e3)}function y({freq:e=440,end:a,dur:n=.15,vol:o=.28,type:i="sine",at:r=0}){const l=ka(),s=l.createOscillator(),t=l.createGain();s.connect(t),t.connect(l.destination),s.type=i,s.frequency.setValueAtTime(e,l.currentTime+r),a!=null&&s.frequency.exponentialRampToValueAtTime(a,l.currentTime+r+n),t.gain.setValueAtTime(o,l.currentTime+r),t.gain.exponentialRampToValueAtTime(.001,l.currentTime+r+n),s.start(l.currentTime+r),s.stop(l.currentTime+r+n+.05)}function ga(e){y(e===0?{freq:523,end:659,dur:.12,vol:.25}:e===1?{freq:349,end:440,dur:.12,vol:.25}:e===2?{freq:420,end:400,dur:.09,vol:.12}:{freq:180,end:70,dur:.28,vol:.35,type:"sawtooth"})}function ba(){y({freq:420,end:300,dur:.08,vol:.1})}function Ga(e){const a=e===0?523:440;[1,1.25,1.5,2,2.5].forEach((n,o)=>y({freq:a*n,dur:.18,vol:.28,at:o*.11}))}function fa(){y({freq:660,end:220,dur:.22,vol:.18,type:"triangle"})}function va(){y({freq:900,end:750,dur:.06,vol:.14,type:"square"})}function $a(){y({freq:260,end:140,dur:.35,vol:.28,type:"sawtooth"})}function Fe(){y({freq:440,end:523,dur:.13,vol:.22}),y({freq:660,end:784,dur:.22,vol:.3,at:.11})}function Na(){y({freq:260,end:140,dur:.3,vol:.22,type:"sawtooth"})}function Ee(){y({freq:620,end:520,dur:.04,vol:.09})}function Oa(){[523,659,784,1047,784,1047,1319].forEach((e,a)=>y({freq:e,end:e*.96,dur:.22,vol:.3,at:a*.1}))}function za(){y({freq:480,end:450,dur:.09,vol:.1})}function ha(){y({freq:440,end:560,dur:.12,vol:.14})}function pn(){y({freq:330,end:660,dur:.2,vol:.13,type:"triangle"})}function mn(e){k=null,ve=null,P=[],J=null,_=new Array(25).fill(null);const a=Me();e.innerHTML=`
    <div class="scene">
  ...
  `,b("connected",()=>{}),b("peer-left",n=>{n===k&&(k=null),P=P.filter(o=>o!==n),Da()}),b("message",(n,o)=>{if(n.type==="cs-hello"){gn(o,n.clientId);return}n.type==="board"&&(J=fe({},n),_=new Array(25).fill(null),bn(e,n),P.filter(i=>i.open).forEach(i=>d(i,fe({type:"board-update"},n)))),n.type==="reveal"&&(_[n.index]={color:n.color,tileType:n.tileType},vn(n.index,n.color,n.tileType),P.filter(i=>i.open).forEach(i=>d(i,{type:"reveal",index:n.index,color:n.color}))),n.type==="hide"&&(_[n.index]=null,hn(n.index,n.tileType),P.filter(i=>i.open).forEach(i=>d(i,{type:"hide",index:n.index}))),n.type==="win"&&(wn(n.team,e),P.filter(i=>i.open).forEach(i=>d(i,{type:"win",team:n.team})))}),b("error",n=>{const o=document.getElementById("status");o&&(o.textContent=`Error: ${n.type}`)}),ua(a)}function gn(e,a){var n;const o=a&&a===ve,i=!((n=k)!==null&&n!==void 0&&n.open);o||i?(k&&k!==e&&(P.push(k),J?d(k,{type:"sync",role:"spectator",board:J,revealed:_}):d(k,{type:"role",role:"spectator"})),k=e,ve=a||ve,J?d(e,{type:"sync",role:"captain",board:J,revealed:_}):d(e,{type:"role",role:"captain"})):(P.includes(e)||P.push(e),J?d(e,{type:"sync",role:"spectator",board:J,revealed:_}):d(e,{type:"role",role:"spectator"})),Da()}function Da(){var e;const a=document.getElementById("status");if(!a)return;const n=P.filter(i=>i.open).length,o=[];(e=k)!==null&&e!==void 0&&e.open&&o.push("¡Capitán conectado!"),n>0&&o.push(`${n} espectador${n>1?"es":""} conectado${n>1?"s":""}`),a.textContent=o.length?o.join(" · "):"Esperando al móvil…"}function bn(e,a){de=[];const n=q[a.isTeamOneFirst?0:1];Le=[a.tiles.filter(i=>i===0).length,a.tiles.filter(i=>i===1).length],H=[...Le],e.innerHTML=`
  ...
  `;const o=document.getElementById("board");a.tiles.forEach((i,r)=>{var l;const s=document.createElement("div");s.className="tile tile-neutral",s.innerHTML=`<span class="tile-word">${(l=a.words[r])!==null&&l!==void 0?l:""}</span>`,o.appendChild(s),de.push(s)}),requestAnimationFrame(()=>de.forEach(fn))}function fn(e){const a=e.querySelector(".tile-word");if(!a)return;let n=parseFloat(getComputedStyle(a).fontSize);for(;a.scrollWidth>a.clientWidth+1&&n>9;)n-=.5,a.style.fontSize=`${n}px`;a.scrollWidth>a.clientWidth+1&&(a.style.letterSpacing="0"),a.scrollWidth>a.clientWidth+1&&(a.style.whiteSpace="normal")}function vn(e,a,n){const o=de[e];if(o){if(o.style.background=a,o.dataset.type=n,o.classList.remove("tile-neutral"),o.classList.add("revealed"),n===2){const i=o.querySelector(".tile-word");i&&(i.style.color="rgba(255,255,255,0.92)")}ma(o),ga(n),(n===0||n===1)&&(H[n]=Math.max(0,H[n]-1),ja(n))}}function hn(e,a){const n=de[e];if(!n)return;n.style.background="",n.classList.remove("revealed"),n.classList.add("tile-neutral");const o=n.querySelector(".tile-word");o&&(o.style.color=""),ba(),(a===0||a===1)&&(H[a]=Math.min(Le[a],H[a]+1),ja(a))}function ja(e){const a=document.getElementById(`c${e}`);a&&(a.textContent=H[e])}function wn(e,a){Ga(e);const n=q[e],o=e===0?"EQUIPO 1":"EQUIPO 2";ge(n);const i=document.createElement("div");i.className="win-overlay",i.innerHTML=`<div class="win-text" style="color:${n}">${o} GANA!</div>`,a.appendChild(i)}function He(){try{let l=localStorage.getItem(Ke);if(!l){var e,a,n;l=(e=(a=(n=crypto).randomUUID)===null||a===void 0?void 0:a.call(n))!==null&&e!==void 0?e:`${Date.now()}-${Math.random().toString(36).slice(2)}`,localStorage.setItem(Ke,l)}return l}catch{var o,i,r;return(o=(i=(r=crypto).randomUUID)===null||i===void 0?void 0:i.call(r))!==null&&o!==void 0?o:`${Date.now()}-${Math.random().toString(36).slice(2)}`}}function wa(e){sessionStorage.setItem(Ie,JSON.stringify(fe(fe({},e),{},{savedAt:Date.now()})))}function ya(){try{const e=sessionStorage.getItem(Ie);return e?JSON.parse(e):null}catch{return null}}function Je(){sessionStorage.removeItem(Ie)}function yn(e){G=e,qn(),e.innerHTML=`
    <div class="scene">
      <h1 class="title">CODIGO</h1>
  ...
  `;const a=document.getElementById("code-input"),n=document.getElementById("connect-btn"),o=document.getElementById("status"),i=()=>{const r=a.value.trim();if(r.length!==4){o.textContent="Ingresa el código de 4 dígitos completo";return}n.disabled=!0,o.textContent="Conectando…",Fa(r)};n.onclick=i,a.addEventListener("keydown",r=>{r.key==="Enter"&&i()})}function Fa(e){ke=e,wa({mode:"cs",code:e}),Ce(),b("connected",()=>{const a=document.getElementById("status");a&&(a.textContent="Conectado, esperando…"),M({type:"cs-hello",clientId:He()})}),b("message",a=>{a.type==="role"&&(a.role==="captain"&&Ve(G),a.role==="spectator"&&qa(G,null,[])),a.type==="sync"&&(a.role==="captain"&&Ve(G,a.board,a.revealed),a.role==="spectator"&&qa(G,a.board,a.revealed)),a.type==="board-update"&&qa(G,a,new Array(25).fill(null)),a.type==="reveal"&&Ja(a.index,a.color),a.type==="hide"&&Mn(a.index),a.type==="win"&&Sn(a.team,G)}),b("error",a=>{const n=document.getElementById("status"),o=document.getElementById("connect-btn");n&&(n.textContent=a.type==="peer-unavailable"?"❌ Código incorrecto — revisa el televisor":`❌ ${a.type}`),o&&(o.disabled=!1)}),pa(e)}function qn(){if(Ye)return;Ye=!0;const e=()=>{if(document.visibilityState!=="visible"||!ke)return;const a=ya();a?.mode==="cs"&&(Se()||Fa(ke))};document.addEventListener("visibilitychange",e),window.addEventListener("focus",e),window.addEventListener("online",e)}function Ve(e,a=null,n=null){G=e,x=a||xa(),Qe=!1,Te=[],V=n?n.map(r=>r!==null):new Array(25).fill(!1),_e=[x.tiles.filter(r=>r===0).length,x.tiles.filter(r=>r===1).length],z=[x.tiles.filter((r,l)=>r===0&&!V[l]).length,x.tiles.filter((r,l)=>r===1&&!V[l]).length];const o=q[x.isTeamOneFirst?0:1];e.innerHTML=`
    <div class="scene board-scene">
  ...
  `;const i=document.getElementById("board");x.tiles.forEach((r,l)=>{var s;const t=document.createElement("div");t.className="tile",t.dataset.type=r,t.style.background=q[r],t.innerHTML=`<span class="tile-word">${(s=x.words[l])!==null&&s!==void 0?s:""}</span>`,t.addEventListener("click",()=>Cn(l,t)),V[l]&&t.classList.add("checked"),i.appendChild(t),Te.push(t)}),requestAnimationFrame(()=>Te.forEach(Va)),a||M(fe({type:"board"},x)),document.getElementById("new-board-btn").addEventListener("click",()=>{confirm("¿Generar un nuevo tablero? Esto reinicia el televisor también.")&&(fa(),Ve(e))})}function Cn(e,a){if(Qe)return;V[e]=!V[e],a.classList.toggle("checked",V[e]);const n=x.tiles[e];V[e]?(ma(a),ga(n),M({type:"reveal",index:e,color:q[n],tileType:n}),(n===0||n===1)&&(z[n]=Math.max(0,z[n]-1),Ha(n),En(n))):(ba(),M({type:"hide",index:e,tileType:n}),(n===0||n===1)&&(z[n]=Math.min(_e[n],z[n]+1),Ha(n)))}function Ha(e){const a=document.getElementById(`c${e}`);a&&(a.textContent=z[e])}function En(e){if(z[e]>0)return;Qe=!0,Ga(e),ge(q[e]),M({type:"win",team:e});const a=document.createElement("div");a.className="win-overlay";const n=e===0?"EQUIPO 1":"EQUIPO 2";a.innerHTML=`
    <div class="win-text" style="color:${q[e]}">${n} GANA!</div>
    <button class="btn" id="win-new-btn">NUEVA PARTIDA</button>
  `,G.appendChild(a),document.getElementById("win-new-btn").addEventListener("click",()=>{fa(),Ve(G)})}function qa(e,a,n){if(ue=[],!a){e.innerHTML=`
      <div class="scene">
        <h1 class="title">CODIGO</h1>
  ...
  `;const i=document.getElementById("spec-board");a.tiles.forEach((r,l)=>{var s;const t=document.createElement("div");t.className="tile tile-neutral",t.innerHTML=`<span class="tile-word">${(s=a.words[l])!==null&&s!==void 0?s:""}</span>`,i.appendChild(t),ue.push(t)}),requestAnimationFrame(()=>ue.forEach(Va)),n.forEach((r,l)=>{r&&Ja(l,r.color)})}function Ja(e,a){const n=ue[e];n&&(n.style.background=a,n.classList.remove("tile-neutral"),n.classList.add("revealed"))}function Mn(e){const a=ue[e];a&&(a.style.background="",a.classList.remove("revealed"),a.classList.add("tile-neutral"))}function Sn(e,a){const n=q[e],o=e===0?"EQUIPO 1":"EQUIPO 2";ge(n);const i=document.createElement("div");i.className="win-overlay",i.innerHTML=`<div class="win-text" style="color:${n}">${o} GANA!</div>`,a.appendChild(i)}function Va(e){const a=e.querySelector(".tile-word");if(!a)return;let n=parseFloat(getComputedStyle(a).fontSize);for(;a.scrollWidth>a.clientWidth+1&&n>9;)n-=.5,a.style.fontSize=`${n}px`;a.scrollWidth>a.clientWidth+1&&(a.style.letterSpacing="0"),a.scrollWidth>a.clientWidth+1&&(a.style.whiteSpace="normal")}function Wa(e){const a=[...e];for(let n=a.length-1;n>0;n--){const o=Math.floor(Math.random()*(n+1));[a[n],a[o]]=[a[o],a[n]]}return a}function An(e,a){he=e,Xe=a,f=new Map,S=-1,$="lobby",A&&(clearInterval(A),A=null),L=Wa(Pe).slice(0,Ze);const n=Me();oa=n,e.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("start-btn").focus(),b("connected",()=>{}),b("peer-left",o=>{if($==="lobby"){for(const[i,r]of f)if(r.conn===o){f.delete(i);break}Ca()}else{for(const i of f.values())if(i.conn===o){i.conn=null;break}We()}}),b("message",(o,i)=>{o.type==="trivia-join"&&Ln(i,o),o.type==="trivia-answer"&&Pn(o)}),document.getElementById("start-btn").addEventListener("click",Tn),ua(n)}function Ln(e,a){const n=a.clientId;if(!n)return;const o=f.get(n);if(o){o.conn=e,o.name=a.name||o.name,Ua(e,o);return}if($!=="lobby"){f.set(n,{name:a.name,score:0,answered:!1,conn:e}),Ua(e,f.get(n)),ha();return}f.set(n,{name:a.name,score:0,answered:!1,conn:e}),d(e,{type:"trivia-waiting"}),ha(),Ca()}function Ua(e,a){if($==="lobby"){d(e,{type:"trivia-waiting"}),Ca();return}if($==="question"){const n=L[S],o=Date.now()-na,i=Math.max(0,ia-o);d(e,{type:"trivia-question",index:S,total:L.length,q:n.q,options:n.options,answer:n.answer,remainingMs:i,myScore:a.score,alreadyAnswered:a.answered}),pe&&d(e,{type:"trivia-reveal",correctIndex:n.answer,scores:In()}),We();return}if($==="interlude"){d(e,{type:"trivia-interlude",scores:ea,myScore:a.score});return}if($==="end"){d(e,{type:"trivia-end",scores:aa});return}}function In(){return[...f.values()].map(e=>({name:e.name,score:e.score}))}function Ca(){const e=document.getElementById("player-list");if(!e)return;e.innerHTML=[...f.values()].map(o=>`<span class="player-chip">${o.name}</span>`).join("");const a=document.getElementById("start-btn");if(!a)return;const n=a.disabled;a.disabled=f.size===0,n&&!a.disabled&&a.focus()}function Tn(){f.forEach(e=>{e.score=0}),ne({type:"trivia-start",total:L.length}),S=-1,Ea()}function Ea(){if(S++,pe=!1,S>=L.length){_a();return}f.forEach(a=>{a.answered=!1}),$="question",na=Date.now();const e=L[S];pn(),Qn(e,S),ne({type:"trivia-question",index:S,total:L.length,q:e.q,options:e.options,answer:e.answer,remainingMs:ia}),kn()}function Qn(e,a){const n="background:rgba(46,95,168,0.12);";he.innerHTML=`
    <div class="scene board-scene">
      <div class="team-banner" style="${n}border-bottom:3px solid var(--accent);justify-content:space-between">
        ...
        <span class="trivia-tv-timer" id="tv-timer">${Be}</span>
      </div>
        ...
        <div class="trivia-tv-options">
          ${e.options.map((o,i)=>`
            <div class="trivia-tv-option" id="opt-${i}">
              <span class="trivia-opt-label">${Pa[i]}</span>
  ...
  `,We()}function kn(){let e=Be;A=setInterval(()=>{e--;const a=document.getElementById("tv-timer");a&&(a.textContent=e,a.className="trivia-tv-timer"+(e<=3?" timer-urgent":"")),e>0&&e<=3&&va(),e<=0&&(clearInterval(A),A=null,$a(),Ka())},1e3)}function Pn(e){const a=f.get(e.clientId);if(!a||a.answered||e.questionIndex!==S)return;a.answered=!0;const n=e.answerIndex===L[S].answer;n&&a.score++,a.conn&&d(a.conn,{type:"trivia-feedback",correct:n}),We(),[...f.values()].every(o=>o.answered)&&(clearInterval(A),A=null,Ka())}function We(){const e=document.getElementById("tv-players");e&&(e.innerHTML=[...f.values()].map(a=>`<span class="player-dot ${a.answered?"dot-answered":""}">${a.name}</span>`).join(""))}function Ka(){if(pe)return;pe=!0;const e=L[S].answer;document.querySelectorAll(".trivia-tv-option").forEach((n,o)=>{n.classList.add(o===e?"opt-correct":"opt-wrong")}),Fe();const a=[...f.values()].map(n=>({name:n.name,score:n.score}));ne({type:"trivia-reveal",correctIndex:e,scores:a}),setTimeout(()=>Bn(a),2500)}function Bn(e){const a=S<L.length-1,n=[...e].sort((o,i)=>i.score-o.score);if($="interlude",ea=n,he.innerHTML=`
    <div class="scene">
  ...
  `,a){ne({type:"trivia-interlude",scores:n});let o=3;A=setInterval(()=>{o--,za();const i=document.getElementById("interlude-count");i&&(i.textContent=o),o<=0&&(clearInterval(A),A=null,Ea())},1e3)}else setTimeout(_a,1500)}function _a(){var e,a;const n=[...f.values()].map(s=>({name:s.name,score:s.score})).sort((s,t)=>t.score-s.score);$="end",aa=n;const o=(e=(a=n[0])===null||a===void 0?void 0:a.score)!==null&&e!==void 0?e:0,i=n.filter(s=>s.score===o&&o>0),l=i.length>1?"EMPATE":i.length?"GANADOR":"FIN";Oa(),ge(n[0]?"#2e5fa8":"#a78bfa"),he.innerHTML=`
    <div class="scene">
      <h1 class="title" style="font-size:2rem;margin-bottom:4px">${l}</h1>
      ${i.length?i.map(s=>`<div class="winner-name">${s.name}</div>`).join(""):'<div class="winner-name">—</div>'}
      ...
      <div class="end-join-block">
        ...
        <span class="end-join-code">${oa}</span>
      </div>
  ...
  `,ne({type:"trivia-end",scores:n}),document.getElementById("again-btn").focus(),document.getElementById("again-btn").onclick=()=>Rn(),document.getElementById("menu-btn").onclick=()=>{var s;return(s=Xe)===null||s===void 0?void 0:s()}}function Rn(){pe=!1,A&&(clearInterval(A),A=null),L=Wa(Pe).slice(0,Ze),f.forEach(e=>{e.score=0,e.answered=!1}),ne({type:"trivia-start",total:L.length}),S=-1,Ea()}function xn(e,a){oe=e,ra=a,Z=0,xe=0,Y=!1,be(),Gn(),$n(e)}function Gn(){if(sa)return;sa=!0;const e=()=>{if(document.visibilityState!=="visible"||!Re||!N)return;const a=ya();a?.mode==="trivia"&&(Se()||Ya(Re,N))};document.addEventListener("visibilitychange",e),window.addEventListener("focus",e),window.addEventListener("online",e)}function be(){ie&&(clearInterval(ie),ie=null),re&&(clearInterval(re),re=null)}function $n(e){e.innerHTML=`
    <div class="scene">
      <h1 class="title">TRIVIA</h1>
  ...
  `;const a=()=>{const n=document.getElementById("code-input").value.trim(),o=document.getElementById("name-input").value.trim(),i=document.getElementById("status");if(n.length!==4){i.textContent="Ingresa el código de 4 dígitos";return}if(!o){i.textContent="Ingresa tu nombre";return}document.getElementById("join-btn").disabled=!0,i.textContent="Conectando…",Ya(n,o)};document.getElementById("join-btn").onclick=a,document.getElementById("name-input").addEventListener("keydown",n=>{n.key==="Enter"&&a()})}function Ya(e,a){Re=e,N=a,wa({mode:"trivia",code:e,name:a}),Ce(),b("connected",()=>{M({type:"trivia-join",name:N,clientId:He()})}),b("message",n=>{n.type==="trivia-waiting"&&Za(oe),n.type==="trivia-start"&&(xe=n.total,Z=0,Za(oe)),n.type==="trivia-question"&&Nn(oe,n),n.type==="trivia-feedback"&&On(n.correct),n.type==="trivia-reveal"&&zn(n.correctIndex),n.type==="trivia-interlude"&&Dn(oe,n),n.type==="trivia-end"&&jn(oe,n.scores)}),b("error",n=>{const o=document.getElementById("status");o&&(o.textContent=n.type==="peer-unavailable"?"❌ Código incorrecto — revisa el televisor":`❌ ${n.type}`);const i=document.getElementById("join-btn");i&&(i.disabled=!1)}),pa(e)}function Za(e){be(),e.innerHTML=`
    <div class="scene">
      <h1 class="title">TRIVIA</h1>
  ...
  `}function Nn(e,a){Y=!!a.alreadyAnswered,$e=-1,Ge=a.answer,typeof a.myScore=="number"&&(Z=a.myScore),be();const n="background:rgba(46,95,168,0.12);";e.innerHTML=`
    <div class="scene board-scene">
  ...
  `,document.querySelectorAll(".trivia-phone-option").forEach(s=>{if(Y){s.disabled=!0;return}s.addEventListener("click",()=>{if(Y)return;Y=!0,Ee(),be();const t=parseInt(s.dataset.idx);$e=t,M({type:"trivia-answer",answerIndex:t,questionIndex:a.index,clientId:He()}),document.querySelectorAll(".trivia-phone-option").forEach(F=>{F.disabled=!0}),s.style.outline="4px solid white",s.style.outlineOffset="-4px",document.getElementById("phone-status").textContent="¡Respuesta enviada!"})});const o=document.getElementById("phone-score");o&&(o.textContent=`${Z} pts`),Y&&(document.getElementById("phone-status").textContent="¡Respuesta enviada!");const i=typeof a.remainingMs=="number"?a.remainingMs:15e3;let r=Math.max(0,Math.ceil(i/1e3));const l=document.getElementById("phone-timer");l&&(l.textContent=r),ie=setInterval(()=>{r--,l&&(l.textContent=r,r<=3&&(l.className="trivia-phone-timer timer-urgent")),r<=0&&(clearInterval(ie),ie=null)},1e3)}function On(e){e&&Z++;const a=document.getElementById("phone-status");a&&(a.textContent=e?"✓ ¡Correcto!":"✗ Incorrecto",a.style.color=e?"#4ade80":"#f87171");const n=document.getElementById("phone-score");n&&(n.textContent=`${Z} pts`),document.querySelectorAll(".trivia-phone-option").forEach(o=>{const i=parseInt(o.dataset.idx);o.style.outline="",o.style.outlineOffset="",i===Ge?o.classList.add("opt-correct"):i===$e?o.classList.add("opt-mine-wrong"):o.classList.add("opt-wrong")}),e?Fe():Na()}function zn(e){if(Y)return;Ge=e,document.querySelectorAll(".trivia-phone-option").forEach(n=>{const o=parseInt(n.dataset.idx);n.disabled=!0,o===e?n.classList.add("opt-correct"):n.classList.add("opt-wrong")});const a=document.getElementById("phone-status");a&&(a.textContent="⏱ Tiempo agotado",a.style.color="#f87171")}function Dn(e,a){be();const n=a.scores;e.innerHTML=`
    <div class="scene">
      <h2 class="trivia-interlude-title">PUNTAJES</h2>
      <div class="trivia-scoreboard">
        ${n.map((i,r)=>`
  ...
  `;let o=3;re=setInterval(()=>{o--,za();const i=document.getElementById("phone-interlude-count");i&&(i.textContent=o),o<=0&&(clearInterval(re),re=null)},1e3)}function jn(e,a){var n,o,i;be();const r=a.find(E=>E.name===N),l=a.findIndex(E=>E.name===N)+1,s=(n=(o=a[0])===null||o===void 0?void 0:o.score)!==null&&n!==void 0?n:0,t=a.filter(E=>E.score===s&&s>0),F=t.some(E=>E.name===N),sn=t.length>1;F&&ge("#2e5fa8");let Ue;F&&sn?Ue='<h1 class="title" style="font-size:2rem">🏆 ¡EMPATE!</h1>':F?Ue='<h1 class="title" style="font-size:2rem">🏆 ¡GANASTE!</h1>':Ue='<h1 class="title" style="font-size:1.6rem;opacity:0.7">FIN</h1>';let tn="";!F&&t.length&&(tn=`
      <div style="text-align:center;margin-top:-4px">
        <div style="font-size:0.85rem;letter-spacing:0.1em;color:rgba(255,255,255,0.45);font-weight:700">${sn?"GANADORES":"GANADOR"}</div>
        <div class="winner-name" style="font-size:clamp(1.4rem,5vw,2.4rem);margin-top:2px">
          ${t.map(La=>La.name).join(" · ")}
        </div>
      </div>
    `),e.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("menu-btn").onclick=()=>{var E;Je(),(E=ra)===null||E===void 0||E()}}function Fn(e,a){W=e,we=a,Xa(),B=null,ye=null,c="lobby",U=Me(),nn(),b("connected",()=>{}),b("peer-left",n=>{n===B&&(B=null,C&&(clearInterval(C),C=null),oo())}),b("message",(n,o)=>{if(n.type==="mimica-hello")return Hn(o,n.clientId);if(n.type==="mimica-setup-teams")return Jn(n.count);if(n.type==="mimica-begin-turn")return Vn();if(n.type==="mimica-correct")return Wn();if(n.type==="mimica-skip")return Un();if(n.type==="mimica-next-team")return Kn();if(n.type==="mimica-restart")return _n()}),ua(U)}function Xa(){C&&(clearInterval(C),C=null),ze="",me=new Set,u=[],m=0,O=0,R=0}function Hn(e,a){var n;const o=a&&a===ye,i=!((n=B)!==null&&n!==void 0&&n.open);o||i?(B=e,ye=a||ye,ha(),c==="lobby"&&(c="setup"),c==="playing"&&!C&&en(),K(),te()):d(e,{type:"mimica-rejected",reason:"captain-taken"})}function K(){B&&(c==="setup"?d(B,{type:"mimica-setup-needed"}):c==="turn-ready"?d(B,{type:"mimica-turn-ready",teams:u,currentTeamIdx:m}):c==="playing"?d(B,{type:"mimica-word",word:ze,remaining:R,aciertosThisTurn:O,teams:u,currentTeamIdx:m}):c==="turn-end"?d(B,{type:"mimica-turn-end",teams:u,currentTeamIdx:m,aciertosThisTurn:O,hasMore:m<u.length-1}):c==="game-end"&&d(B,{type:"mimica-game-end",teams:u}))}function Jn(e){if(c!=="setup")return;const a=Math.max(2,Math.min(6,Number(e)||0));u=Array.from({length:a},(n,o)=>({name:`Equipo ${o+1}`,score:0})),m=0,O=0,c="turn-ready",K(),te()}function Vn(){c==="turn-ready"&&(O=0,R=Ba,c="playing",Ma(),en(),K(),te())}function Wn(){c==="playing"&&(O++,u[m].score++,Fe(),Ma(),K(),on())}function Un(){c==="playing"&&(Ma(),K(),on())}function Kn(){if(c==="turn-end"){if(m>=u.length-1){Yn();return}m++,O=0,c="turn-ready",K(),te()}}function _n(){c==="game-end"&&(Xa(),c="setup",K(),te())}function Ma(){me.size>=Ne.length&&me.clear();let e;do e=Ne[Math.floor(Math.random()*Ne.length)];while(me.has(e));me.add(e),ze=e}function en(){C&&clearInterval(C),C=setInterval(()=>{R--;const e=document.getElementById("mimica-timer");e&&(e.textContent=R,e.className="mimica-timer"+(R<=5?" timer-urgent":"")),R>0&&R<=5&&va(),R<=0&&(clearInterval(C),C=null,$a(),c="turn-end",K(),te())},1e3)}function Yn(){var e;c="game-end",C&&(clearInterval(C),C=null),Oa();const a=[...u].sort((n,o)=>o.score-n.score);ge((e=Oe[u.indexOf(a[0])])!==null&&e!==void 0?e:"#2e5fa8"),K(),te()}function te(){if(c==="lobby")return nn();if(c==="setup")return Zn();if(c==="turn-ready")return Xn();if(c==="playing")return eo();if(c==="turn-end")return ao();if(c==="game-end")return no()}function ee(e){return Oe[e%Oe.length]}function an(e=-1){return`
  ...
  `,document.getElementById("menu-btn").onclick=()=>{var e;return(e=we)===null||e===void 0?void 0:e()}}function Zn(){W.innerHTML=`
    <div class="scene">
      <h1 class="title">MÍMICA</h1>
  ...
  `}function Xn(){const e=u[m];W.innerHTML=`
    <div class="scene mimica-scene">
      ...
      <div class="mimica-ready-center">
        ...
        <div class="mimica-ready-team" style="color:${ee(m)}">${e.name}</div>
        <div class="mimica-ready-help">Pasa el móvil al capitán de este equipo</div>
      </div>
      <div class="mimica-foot">${an(m)}</div>
    </div>
  `}function eo(){const e=u[m];W.innerHTML=`
    <div class="scene mimica-scene">
      <div class="mimica-top">
        <span class="mimica-team-tag" style="background:${ee(m)}22;color:${ee(m)}">${e.name}</span>
  ...
  `}function on(){const e=document.getElementById("mimica-aciertos");e&&(e.textContent=O)}function ao(){const e=u[m],a=m>=u.length-1;W.innerHTML=`
    <div class="scene mimica-scene">
      <div class="mimica-top">
        <span class="mimica-code">${U}</span>
        <span class="mimica-progress">Turno ${m+1} / ${u.length}</span>
      ...
      <div class="mimica-turnend-center">
        ...
        <div class="mimica-turnend-team" style="color:${ee(m)}">${e.name}</div>
  ...
  `}function no(){var e,a;const n=[...u].sort((s,t)=>t.score-s.score),o=(e=(a=n[0])===null||a===void 0?void 0:a.score)!==null&&e!==void 0?e:0,i=n.filter(s=>s.score===o&&o>0),l=i.length>1?"EMPATE":i.length?"GANA":"FIN";W.innerHTML=`
    <div class="scene">
      <h1 class="title" style="font-size:2rem;margin-bottom:4px">${l}</h1>
      ${i.length?i.map(s=>`<div class="winner-name" style="color:${ee(u.indexOf(s))}">${s.name}</div>`).join(""):'<div class="winner-name">—</div>'}
      <div class="mimica-scoreboard" style="margin-top:24px;max-width:520px;width:100%">
        ${n.map(s=>{const t=u.indexOf(s);return`
          <div class="mimica-score-row" style="--team-color:${ee(t)}">
            <span class="mimica-score-dot"></span>
            <span class="mimica-score-name">${s.name}</span>
  ...
  `,document.getElementById("menu-btn").onclick=()=>{var s;return(s=we)===null||s===void 0?void 0:s()}}function oo(){W.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("menu-btn").onclick=()=>{var e;return(e=we)===null||e===void 0?void 0:e()}}function io(e,a){X=e,De=a,ro(),so(e)}function ro(){if(la)return;la=!0;const e=()=>{if(document.visibilityState!=="visible"||!je)return;const a=ya();a?.mode==="mimica"&&(Se()||rn(je))};document.addEventListener("visibilitychange",e),window.addEventListener("focus",e),window.addEventListener("online",e)}function j(e){return ta[e%ta.length]}function so(e){e.innerHTML=`
    <div class="scene">
      <h1 class="title">MÍMICA</h1>
  ...
  `;const a=document.getElementById("code-input"),n=document.getElementById("connect-btn"),o=document.getElementById("status"),i=()=>{const r=a.value.trim();if(r.length!==4){o.textContent="Ingresa el código de 4 dígitos";return}n.disabled=!0,o.textContent="Conectando…",rn(r)};n.onclick=i,a.addEventListener("keydown",r=>{r.key==="Enter"&&i()})}function rn(e){je=e,wa({mode:"mimica",code:e}),Ce(),ae(),b("connected",()=>{M({type:"mimica-hello",clientId:He()})}),b("message",a=>{if(a.type==="mimica-setup-needed")return to();if(a.type==="mimica-turn-ready")return lo(a);if(a.type==="mimica-word")return co(a);if(a.type==="mimica-turn-end")return mo(a);if(a.type==="mimica-game-end")return go(a);if(a.type==="mimica-rejected")return bo()}),b("error",a=>{const n=document.getElementById("status");n&&(n.textContent=a.type==="peer-unavailable"?"❌ Código incorrecto — revisa el televisor":`❌ ${a.type}`);const o=document.getElementById("connect-btn");o&&(o.disabled=!1)}),pa(e)}function to(){ae(),X.innerHTML=`
    <div class="scene">
  ...
  `,document.querySelectorAll(".mimica-setup-btn").forEach(e=>{e.onclick=()=>{Ee(),M({type:"mimica-setup-teams",count:parseInt(e.dataset.n)})}})}function lo(e){ae(),T=e.teams,I=e.currentTeamIdx;const a=T[I];X.innerHTML=`
    <div class="scene">
  ...
  `;const n=document.getElementById("begin-btn");n.focus(),n.onclick=()=>{Ee(),M({type:"mimica-begin-turn"})}}function co(e){ca=e.word,D=e.remaining,se=e.aciertosThisTurn,T=e.teams,I=e.currentTeamIdx,uo(),po()}function uo(){const e=T[I];X.innerHTML=`
  ...
  `,document.getElementById("correct-btn").onclick=()=>{Fe(),se++;const a=document.getElementById("phone-aciertos");a&&(a.textContent=se),M({type:"mimica-correct"})},document.getElementById("pass-btn").onclick=()=>{Na(),M({type:"mimica-skip"})}}function po(){ae(),qe=setInterval(()=>{D--;const e=document.getElementById("mimica-phone-timer");e&&(e.textContent=`${D}s`,D<=5&&e.classList.add("timer-urgent")),D>0&&D<=5&&va(),D<=0&&ae()},1e3)}function ae(){qe&&(clearInterval(qe),qe=null)}function mo(e){ae(),T=e.teams,I=e.currentTeamIdx,se=e.aciertosThisTurn;const a=T[I],n=!e.hasMore;X.innerHTML=`
    <div class="scene">
  ...
  `;const o=document.getElementById("next-btn");o.focus(),o.onclick=()=>{Ee(),M({type:"mimica-next-team"})}}function go(e){var a,n;ae(),T=e.teams;const o=[...T].sort((t,F)=>F.score-t.score),i=(a=(n=o[0])===null||n===void 0?void 0:n.score)!==null&&a!==void 0?a:0,r=o.filter(t=>t.score===i&&i>0),s=r.length>1?"🏆 ¡EMPATE!":r.length?"🏆 ¡GANADOR!":"FIN";X.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("again-btn").focus(),document.getElementById("again-btn").onclick=()=>{Ee(),M({type:"mimica-restart"})},document.getElementById("menu-btn").onclick=()=>{var t;Je(),(t=De)===null||t===void 0||t()}}function bo(){ae(),X.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("back-btn").onclick=()=>{var e;Je(),(e=De)===null||e===void 0||e()}}function fo(e,a){n();function n(){const o=xa(),i=q[o.isTeamOneFirst?0:1];e.innerHTML=`
      <div class="scene board-scene">
    ...
    `;const r=document.getElementById("board");o.tiles.forEach(l=>{const s=document.createElement("div");s.className="tile",s.dataset.type=l,s.style.background=q[l],s.addEventListener("click",()=>{const t=!s.classList.contains("checked");s.classList.toggle("checked",t),t?(ma(s),ga(l)):ba()}),r.appendChild(s)}),document.getElementById("back-btn").onclick=a,document.getElementById("new-map-btn").onclick=()=>{confirm("¿Generar un nuevo mapa?")&&(fa(),n())}}}function vo(){da||(da=!0,document.addEventListener("keydown",e=>{if(e.key!=="ArrowDown"&&e.key!=="ArrowUp")return;const a=[...document.querySelectorAll(".btn")];if(!a.length)return;const n=a.indexOf(document.activeElement);e.key==="ArrowDown"&&a[Math.min(n+1,a.length-1)].focus(),e.key==="ArrowUp"&&a[Math.max(n-1,0)].focus(),e.preventDefault()}))}function Sa(e){Ce(),Je(),vo(),e.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("cs-btn").focus(),document.getElementById("cs-btn").onclick=()=>Aa(e,"cs"),document.getElementById("trivia-btn").onclick=()=>Aa(e,"trivia"),document.getElementById("mimica-btn").onclick=()=>Aa(e,"mimica"),document.getElementById("mapa-btn").onclick=()=>fo(e,()=>Sa(e))}function Aa(e,a){Ce();const o={cs:"CÓDIGO SECRETO",trivia:"TRIVIA",mimica:"MÍMICA"}[a];e.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("tv-btn").focus();const i=()=>Sa(e);document.getElementById("tv-btn").onclick=()=>{if(a==="cs")return mn(e);if(a==="trivia")return An(e,i);if(a==="mimica")return Fn(e,i)},document.getElementById("phone-btn").onclick=()=>{if(a==="cs")return yn(e);if(a==="trivia")return xn(e,i);if(a==="mimica")return io(e,i)},document.getElementById("back-btn").onclick=i}return{setters:[],execute:function(){v=typeof window<"u"&&window.CODIGO_WS_URL||"wss://codigo-relay.onrender.com",w=new Map,Q=(e,...a)=>{var n;return(n=w.get(e))===null||n===void 0?void 0:n(...a)},b=(e,a)=>w.set(e,a),h=null,le=null,ce=new Map,Me=()=>String(Math.floor(1e3+Math.random()*9e3)),M=e=>{var a;((a=h)===null||a===void 0?void 0:a.readyState)===WebSocket.OPEN&&h.send(JSON.stringify({type:"to-host",payload:e}))},d=(e,a)=>{var n;((n=h)===null||n===void 0?void 0:n.readyState)===WebSocket.OPEN&&h.send(JSON.stringify({type:"to-peer",peerId:e.id,payload:a}))},ne=e=>{var a;((a=h)===null||a===void 0?void 0:a.readyState)===WebSocket.OPEN&&h.send(JSON.stringify({type:"broadcast",payload:e}))},Se=()=>{var e;return((e=h)===null||e===void 0?void 0:e.readyState)===WebSocket.OPEN&&le==="phone"},Ta=`
abogado
aceite
áfrica
agente
