(function(){function Pa(p,g){var v=Object.keys(p);if(Object.getOwnPropertySymbols){var w=Object.getOwnPropertySymbols(p);g&&(w=w.filter(function(Q){return Object.getOwnPropertyDescriptor(p,Q).enumerable})),v.push.apply(v,w)}return v}function he(p){for(var g=1;g<arguments.length;g++){var v=arguments[g]!=null?arguments[g]:{};g%2?Pa(Object(v),!0).forEach(function(w){pn(p,w,v[w])}):Object.getOwnPropertyDescriptors?Object.defineProperties(p,Object.getOwnPropertyDescriptors(v)):Pa(Object(v)).forEach(function(w){Object.defineProperty(p,w,Object.getOwnPropertyDescriptor(v,w))})}return p}function pn(p,g,v){return(g=mn(g))in p?Object.defineProperty(p,g,{value:v,enumerable:!0,configurable:!0,writable:!0}):p[g]=v,p}function mn(p){var g=gn(p,"string");return typeof g=="symbol"?g:g+""}function gn(p,g){if(typeof p!="object"||!p)return p;var v=p[Symbol.toPrimitive];if(v!==void 0){var w=v.call(p,g||"default");if(typeof w!="object")return w;throw new TypeError("@@toPrimitive must return a primitive value.")}return(g==="string"?String:Number)(p)}System.register([],function(p,g){"use strict";var v,w,Q,b,h,de,ue,Le,M,d,ne,Ie,Ba,Ra,q,Te,xa,pe,H,Qe,k,we,P,J,_,Xe,ke,x,V,Pe,z,ea,Be,$,me,Re,aa,xe,$e,na,$a,ye,oa,f,S,ge,A,L,G,ia,ra,sa,ta,la,oe,ca,N,Ge,Y,Z,Ne,ie,re,Oe,ze,da,De,Ga,je,W,qe,B,Ce,Fe,be,R,C,u,m,O,c,U,ua,X,He,Je,pa,Ee,D,ma,se,T,I,ga;function Na(e){h=new WebSocket(v),h.addEventListener("open",e),h.addEventListener("error",()=>Q("error",{type:"network"})),h.addEventListener("close",()=>{de==="phone"&&Q("disconnected")}),h.addEventListener("message",a=>{let n;try{n=JSON.parse(a.data)}catch{return}bn(n)})}function bn(e){switch(e.type){case"ready":break;case"peer-joined":{const a={id:e.peerId,open:!0};ue.set(e.peerId,a),Q("connected",a);break}case"from-peer":{const a=ue.get(e.peerId);a&&Q("message",e.payload,a);break}case"peer-left":{const a=ue.get(e.peerId);a&&(a.open=!1,ue.delete(e.peerId),Q("peer-left",a));break}case"joined":Q("connected");break;case"from-host":Q("message",e.payload);break;case"host-left":Q("disconnected");break;case"error":Q("error",{type:e.error});break}}function ba(e){de="tv",Na(()=>h.send(JSON.stringify({type:"host",code:e})))}function fa(e){de="phone",Na(()=>h.send(JSON.stringify({type:"join",code:e})))}function Me(){h&&(h.close(),h=null),de=null,ue.clear(),w.clear()}function Oa(){const e=Math.random()<.5,a=[...Array(e?9:8).fill(0),...Array(e?8:9).fill(1),...Array(7).fill(2),...Array(1).fill(3)];for(let i=a.length-1;i>0;i--){const r=Math.floor(Math.random()*(i+1));[a[i],a[r]]=[a[r],a[i]]}const n=[...Ra];for(let i=n.length-1;i>0;i--){const r=Math.floor(Math.random()*(i+1));[n[i],n[r]]=[n[r],n[i]]}const o=n.slice(0,25);return{tiles:a,isTeamOneFirst:e,words:o}}function va(e){e.animate&&e.animate([{transform:"scale(0.88)",opacity:.6},{transform:"scale(1.06)",opacity:1},{transform:"scale(1)",opacity:1}],{duration:240,easing:"ease-out",fill:"none"})}function fe(e){const a=document.createElement("canvas");a.style.cssText="position:fixed;top:0;right:0;bottom:0;left:0;inset:0;width:100%;height:100%;pointer-events:none;z-index:999",document.body.appendChild(a);const n=a.getContext("2d");a.width=window.innerWidth,a.height=window.innerHeight;const i=Array.from({length:120},()=>({x:Math.random()*a.width,y:-20-Math.random()*80,vx:(Math.random()-.5)*4,vy:2+Math.random()*4,rot:Math.random()*Math.PI*2,vrot:(Math.random()-.5)*.2,w:8+Math.random()*8,h:5+Math.random()*5,color:Math.random()<.6?e:"#fbb954",alpha:1}));let r;const l=()=>{n.clearRect(0,0,a.width,a.height);let s=!1;for(const t of i)t.x+=t.vx,t.y+=t.vy,t.vy+=.08,t.rot+=t.vrot,t.y>a.height*.85&&(t.alpha-=.03),!(t.alpha<=0)&&(s=!0,n.save(),n.globalAlpha=t.alpha,n.translate(t.x,t.y),n.rotate(t.rot),n.fillStyle=t.color,n.fillRect(-t.w/2,-t.h/2,t.w,t.h),n.restore());s?r=requestAnimationFrame(l):a.remove()};r=requestAnimationFrame(l),setTimeout(()=>{cancelAnimationFrame(r),a.remove()},4e3)}function y({freq:e=440,end:a,dur:n=.15,vol:o=.28,type:i="sine",at:r=0}){const l=xa(),s=l.createOscillator(),t=l.createGain();s.connect(t),t.connect(l.destination),s.type=i,s.frequency.setValueAtTime(e,l.currentTime+r),a!=null&&s.frequency.exponentialRampToValueAtTime(a,l.currentTime+r+n),t.gain.setValueAtTime(o,l.currentTime+r),t.gain.exponentialRampToValueAtTime(.001,l.currentTime+r+n),s.start(l.currentTime+r),s.stop(l.currentTime+r+n+.05)}function ha(e){y(e===0?{freq:523,end:659,dur:.12,vol:.25}:e===1?{freq:349,end:440,dur:.12,vol:.25}:e===2?{freq:420,end:400,dur:.09,vol:.12}:{freq:180,end:70,dur:.28,vol:.35,type:"sawtooth"})}function wa(){y({freq:420,end:300,dur:.08,vol:.1})}function za(e){const a=e===0?523:440;[1,1.25,1.5,2,2.5].forEach((n,o)=>y({freq:a*n,dur:.18,vol:.28,at:o*.11}))}function ya(){y({freq:660,end:220,dur:.22,vol:.18,type:"triangle"})}function qa(){y({freq:900,end:750,dur:.06,vol:.14,type:"square"})}function Da(){y({freq:260,end:140,dur:.35,vol:.28,type:"sawtooth"})}function Ve(){y({freq:440,end:523,dur:.13,vol:.22}),y({freq:660,end:784,dur:.22,vol:.3,at:.11})}function ja(){y({freq:260,end:140,dur:.3,vol:.22,type:"sawtooth"})}function Se(){y({freq:620,end:520,dur:.04,vol:.09})}function Fa(){[523,659,784,1047,784,1047,1319].forEach((e,a)=>y({freq:e,end:e*.96,dur:.22,vol:.3,at:a*.1}))}function Ha(){y({freq:480,end:450,dur:.09,vol:.1})}function Ca(){y({freq:440,end:560,dur:.12,vol:.14})}function fn(){y({freq:330,end:660,dur:.2,vol:.13,type:"triangle"})}function vn(e){k=null,we=null,P=[],J=null,_=new Array(25).fill(null);const a=Le();e.innerHTML=`
    <div class="scene">
  ...
  `,b("connected",()=>{}),b("peer-left",n=>{n===k&&(k=null),P=P.filter(o=>o!==n),Ja()}),b("message",(n,o)=>{if(n.type==="cs-hello"){hn(o,n.clientId);return}n.type==="board"&&(J=he({},n),_=new Array(25).fill(null),wn(e,n),P.filter(i=>i.open).forEach(i=>d(i,he({type:"board-update"},n)))),n.type==="reveal"&&(_[n.index]={color:n.color,tileType:n.tileType},qn(n.index,n.color,n.tileType),P.filter(i=>i.open).forEach(i=>d(i,{type:"reveal",index:n.index,color:n.color}))),n.type==="hide"&&(_[n.index]=null,Cn(n.index,n.tileType),P.filter(i=>i.open).forEach(i=>d(i,{type:"hide",index:n.index}))),n.type==="win"&&(En(n.team,e),P.filter(i=>i.open).forEach(i=>d(i,{type:"win",team:n.team})))}),b("error",n=>{const o=document.getElementById("status");o&&(o.textContent=`Error: ${n.type}`)}),ba(a)}function hn(e,a){var n;const o=a&&a===we,i=!((n=k)!==null&&n!==void 0&&n.open);o||i?(k&&k!==e&&(P.push(k),J?d(k,{type:"sync",role:"spectator",board:J,revealed:_}):d(k,{type:"role",role:"spectator"})),k=e,we=a||we,J?d(e,{type:"sync",role:"captain",board:J,revealed:_}):d(e,{type:"role",role:"captain"})):(P.includes(e)||P.push(e),J?d(e,{type:"sync",role:"spectator",board:J,revealed:_}):d(e,{type:"role",role:"spectator"})),Ja()}function Ja(){var e;const a=document.getElementById("status");if(!a)return;const n=P.filter(i=>i.open).length,o=[];(e=k)!==null&&e!==void 0&&e.open&&o.push("¡Capitán conectado!"),n>0&&o.push(`${n} espectador${n>1?"es":""} conectado${n>1?"s":""}`),a.textContent=o.length?o.join(" · "):"Esperando al móvil…"}function wn(e,a){pe=[];const n=q[a.isTeamOneFirst?0:1];Qe=[a.tiles.filter(i=>i===0).length,a.tiles.filter(i=>i===1).length],H=[...Qe],e.innerHTML=`
  ...
  `;const o=document.getElementById("board");a.tiles.forEach((i,r)=>{var l;const s=document.createElement("div");s.className="tile tile-neutral",s.innerHTML=`<span class="tile-word">${(l=a.words[r])!==null&&l!==void 0?l:""}</span>`,o.appendChild(s),pe.push(s)}),requestAnimationFrame(()=>pe.forEach(yn))}function yn(e){const a=e.querySelector(".tile-word");if(!a)return;let n=parseFloat(getComputedStyle(a).fontSize);for(;a.scrollWidth>a.clientWidth+1&&n>9;)n-=.5,a.style.fontSize=`${n}px`;a.scrollWidth>a.clientWidth+1&&(a.style.letterSpacing="0"),a.scrollWidth>a.clientWidth+1&&(a.style.whiteSpace="normal")}function qn(e,a,n){const o=pe[e];if(o){if(o.style.background=a,o.dataset.type=n,o.classList.remove("tile-neutral"),o.classList.add("revealed"),n===2){const i=o.querySelector(".tile-word");i&&(i.style.color="rgba(255,255,255,0.92)")}va(o),ha(n),(n===0||n===1)&&(H[n]=Math.max(0,H[n]-1),Va(n))}}function Cn(e,a){const n=pe[e];if(!n)return;n.style.background="",n.classList.remove("revealed"),n.classList.add("tile-neutral");const o=n.querySelector(".tile-word");o&&(o.style.color=""),wa(),(a===0||a===1)&&(H[a]=Math.min(Qe[a],H[a]+1),Va(a))}function Va(e){const a=document.getElementById(`c${e}`);a&&(a.textContent=H[e])}function En(e,a){za(e);const n=q[e],o=e===0?"EQUIPO 1":"EQUIPO 2";fe(n);const i=document.createElement("div");i.className="win-overlay",i.innerHTML=`<div class="win-text" style="color:${n}">${o} GANA!</div>`,a.appendChild(i)}function We(){try{let l=localStorage.getItem(Xe);if(!l){var e,a,n;l=(e=(a=(n=crypto).randomUUID)===null||a===void 0?void 0:a.call(n))!==null&&e!==void 0?e:`${Date.now()}-${Math.random().toString(36).slice(2)}`,localStorage.setItem(Xe,l)}return l}catch{var o,i,r;return(o=(i=(r=crypto).randomUUID)===null||i===void 0?void 0:i.call(r))!==null&&o!==void 0?o:`${Date.now()}-${Math.random().toString(36).slice(2)}`}}function Ea(e){sessionStorage.setItem(ke,JSON.stringify(he(he({},e),{},{savedAt:Date.now()})))}function Ma(){try{const e=sessionStorage.getItem(ke);return e?JSON.parse(e):null}catch{return null}}function Ue(){sessionStorage.removeItem(ke)}function Mn(e){$=e,Sn(),e.innerHTML=`
    <div class="scene">
      <h1 class="title">CODIGO</h1>
  ...
  `;const a=document.getElementById("code-input"),n=document.getElementById("connect-btn"),o=document.getElementById("status"),i=()=>{const r=a.value.trim();if(r.length!==4){o.textContent="Ingresa el código de 4 dígitos completo";return}n.disabled=!0,o.textContent="Conectando…",Wa(r)};n.onclick=i,a.addEventListener("keydown",r=>{r.key==="Enter"&&i()})}function Wa(e){Re=e,Ea({mode:"cs",code:e}),Me(),b("connected",()=>{const a=document.getElementById("status");a&&(a.textContent="Conectado, esperando…"),M({type:"cs-hello",clientId:We()})}),b("message",a=>{a.type==="role"&&(a.role==="captain"&&Ke($),a.role==="spectator"&&Sa($,null,[])),a.type==="sync"&&(a.role==="captain"&&Ke($,a.board,a.revealed),a.role==="spectator"&&Sa($,a.board,a.revealed)),a.type==="board-update"&&Sa($,a,new Array(25).fill(null)),a.type==="reveal"&&Ka(a.index,a.color),a.type==="hide"&&In(a.index),a.type==="win"&&Tn(a.team,$)}),b("error",a=>{const n=document.getElementById("status"),o=document.getElementById("connect-btn");n&&(n.textContent=a.type==="peer-unavailable"?"❌ Código incorrecto — revisa el televisor":`❌ ${a.type}`),o&&(o.disabled=!1)}),fa(e)}function Sn(){if(aa)return;aa=!0;const e=()=>{if(document.visibilityState!=="visible"||!Re)return;const a=Ma();a?.mode==="cs"&&(Ie()||Wa(Re))};document.addEventListener("visibilitychange",e),window.addEventListener("focus",e),window.addEventListener("online",e)}function Ke(e,a=null,n=null){$=e,x=a||Oa(),Be=!1,Pe=[],V=n?n.map(r=>r!==null):new Array(25).fill(!1),ea=[x.tiles.filter(r=>r===0).length,x.tiles.filter(r=>r===1).length],z=[x.tiles.filter((r,l)=>r===0&&!V[l]).length,x.tiles.filter((r,l)=>r===1&&!V[l]).length];const o=q[x.isTeamOneFirst?0:1];e.innerHTML=`
    <div class="scene board-scene">
  ...
  `;const i=document.getElementById("board");x.tiles.forEach((r,l)=>{var s;const t=document.createElement("div");t.className="tile",t.dataset.type=r,t.style.background=q[r],t.innerHTML=`<span class="tile-word">${(s=x.words[l])!==null&&s!==void 0?s:""}</span>`,t.addEventListener("click",()=>An(l,t)),V[l]&&t.classList.add("checked"),i.appendChild(t),Pe.push(t)}),requestAnimationFrame(()=>Pe.forEach(_a)),a||M(he({type:"board"},x)),document.getElementById("new-board-btn").addEventListener("click",()=>{confirm("¿Generar un nuevo tablero? Esto reinicia el televisor también.")&&(ya(),Ke(e))})}function An(e,a){if(Be)return;V[e]=!V[e],a.classList.toggle("checked",V[e]);const n=x.tiles[e];V[e]?(va(a),ha(n),M({type:"reveal",index:e,color:q[n],tileType:n}),(n===0||n===1)&&(z[n]=Math.max(0,z[n]-1),Ua(n),Ln(n))):(wa(),M({type:"hide",index:e,tileType:n}),(n===0||n===1)&&(z[n]=Math.min(ea[n],z[n]+1),Ua(n)))}function Ua(e){const a=document.getElementById(`c${e}`);a&&(a.textContent=z[e])}function Ln(e){if(z[e]>0)return;Be=!0,za(e),fe(q[e]),M({type:"win",team:e});const a=document.createElement("div");a.className="win-overlay";const n=e===0?"EQUIPO 1":"EQUIPO 2";a.innerHTML=`
    <div class="win-text" style="color:${q[e]}">${n} GANA!</div>
    <button class="btn" id="win-new-btn">NUEVA PARTIDA</button>
  `,$.appendChild(a),document.getElementById("win-new-btn").addEventListener("click",()=>{ya(),Ke($)})}function Sa(e,a,n){if(me=[],!a){e.innerHTML=`
      <div class="scene">
        <h1 class="title">CODIGO</h1>
  ...
  `;const i=document.getElementById("spec-board");a.tiles.forEach((r,l)=>{var s;const t=document.createElement("div");t.className="tile tile-neutral",t.innerHTML=`<span class="tile-word">${(s=a.words[l])!==null&&s!==void 0?s:""}</span>`,i.appendChild(t),me.push(t)}),requestAnimationFrame(()=>me.forEach(_a)),n.forEach((r,l)=>{r&&Ka(l,r.color)})}function Ka(e,a){const n=me[e];n&&(n.style.background=a,n.classList.remove("tile-neutral"),n.classList.add("revealed"))}function In(e){const a=me[e];a&&(a.style.background="",a.classList.remove("revealed"),a.classList.add("tile-neutral"))}function Tn(e,a){const n=q[e],o=e===0?"EQUIPO 1":"EQUIPO 2";fe(n);const i=document.createElement("div");i.className="win-overlay",i.innerHTML=`<div class="win-text" style="color:${n}">${o} GANA!</div>`,a.appendChild(i)}function _a(e){const a=e.querySelector(".tile-word");if(!a)return;let n=parseFloat(getComputedStyle(a).fontSize);for(;a.scrollWidth>a.clientWidth+1&&n>9;)n-=.5,a.style.fontSize=`${n}px`;a.scrollWidth>a.clientWidth+1&&(a.style.letterSpacing="0"),a.scrollWidth>a.clientWidth+1&&(a.style.whiteSpace="normal")}function Ae(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Ya(e){const a=[...e];for(let n=a.length-1;n>0;n--){const o=Math.floor(Math.random()*(n+1));[a[n],a[o]]=[a[o],a[n]]}return a}function Qn(e,a){ye=e,oa=a,f=new Map,S=-1,G="lobby",A&&(clearInterval(A),A=null),L=Ya(xe).slice(0,na);const n=Le();ta=n,e.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("start-btn").focus(),b("connected",()=>{}),b("peer-left",o=>{if(G==="lobby"){for(const[i,r]of f)if(r.conn===o){f.delete(i);break}Aa()}else{for(const i of f.values())if(i.conn===o){i.conn=null;break}_e()}}),b("message",(o,i)=>{o.type==="trivia-join"&&kn(i,o),o.type==="trivia-answer"&&$n(o)}),document.getElementById("start-btn").addEventListener("click",Bn),ba(n)}function kn(e,a){const n=a.clientId;if(!n)return;const o=f.get(n);if(o){o.conn=e,o.name=a.name||o.name,Za(e,o);return}if(G!=="lobby"){f.set(n,{name:a.name,score:0,answered:!1,conn:e}),Za(e,f.get(n)),Ca();return}f.set(n,{name:a.name,score:0,answered:!1,conn:e}),d(e,{type:"trivia-waiting"}),Ca(),Aa()}function Za(e,a){if(G==="lobby"){d(e,{type:"trivia-waiting"}),Aa();return}if(G==="question"){const n=L[S],o=Date.now()-sa,i=Math.max(0,la-o);d(e,{type:"trivia-question",index:S,total:L.length,q:n.q,options:n.options,answer:n.answer,remainingMs:i,myScore:a.score,alreadyAnswered:a.answered}),ge&&d(e,{type:"trivia-reveal",correctIndex:n.answer,scores:Pn()}),_e();return}if(G==="interlude"){d(e,{type:"trivia-interlude",scores:ia,myScore:a.score});return}if(G==="end"){d(e,{type:"trivia-end",scores:ra});return}}function Pn(){return[...f.values()].map(e=>({name:e.name,score:e.score}))}function Aa(){const e=document.getElementById("player-list");if(!e)return;e.innerHTML=[...f.values()].map(o=>`<span class="player-chip">${Ae(o.name)}</span>`).join("");const a=document.getElementById("start-btn");if(!a)return;const n=a.disabled;a.disabled=f.size===0,n&&!a.disabled&&a.focus()}function Bn(){f.forEach(e=>{e.score=0}),ne({type:"trivia-start",total:L.length}),S=-1,La()}function La(){if(S++,ge=!1,S>=L.length){en();return}f.forEach(a=>{a.answered=!1}),G="question",sa=Date.now();const e=L[S];fn(),Rn(e,S),ne({type:"trivia-question",index:S,total:L.length,q:e.q,options:e.options,answer:e.answer,remainingMs:la}),xn()}function Rn(e,a){const n="background:rgba(46,95,168,0.12);";ye.innerHTML=`
    <div class="scene board-scene">
      <div class="team-banner" style="${n}border-bottom:3px solid var(--accent);justify-content:space-between">
        ...
        <span class="trivia-tv-timer" id="tv-timer">${$e}</span>
      </div>
        ...
        <div class="trivia-tv-options">
          ${e.options.map((o,i)=>`
            <div class="trivia-tv-option" id="opt-${i}">
              <span class="trivia-opt-label">${$a[i]}</span>
  ...
  `,_e()}function xn(){let e=$e;A=setInterval(()=>{e--;const a=document.getElementById("tv-timer");a&&(a.textContent=e,a.className="trivia-tv-timer"+(e<=3?" timer-urgent":"")),e>0&&e<=3&&qa(),e<=0&&(clearInterval(A),A=null,Da(),Xa())},1e3)}function $n(e){const a=f.get(e.clientId);if(!a||a.answered||e.questionIndex!==S)return;a.answered=!0;const n=e.answerIndex===L[S].answer;n&&a.score++,a.conn&&d(a.conn,{type:"trivia-feedback",correct:n}),_e(),[...f.values()].every(o=>o.answered)&&(clearInterval(A),A=null,Xa())}function _e(){const e=document.getElementById("tv-players");e&&(e.innerHTML=[...f.values()].map(a=>`<span class="player-dot ${a.answered?"dot-answered":""}">${Ae(a.name)}</span>`).join(""))}function Xa(){if(ge)return;ge=!0;const e=L[S].answer;document.querySelectorAll(".trivia-tv-option").forEach((n,o)=>{n.classList.add(o===e?"opt-correct":"opt-wrong")}),Ve();const a=[...f.values()].map(n=>({name:n.name,score:n.score}));ne({type:"trivia-reveal",correctIndex:e,scores:a}),setTimeout(()=>Gn(a),2500)}function Gn(e){const a=S<L.length-1,n=[...e].sort((o,i)=>i.score-o.score);if(G="interlude",ia=n,ye.innerHTML=`
    <div class="scene">
      ...
      <div class="trivia-scoreboard">
        ${n.map((o,i)=>`
          <div class="score-row">
            ...
            <span class="score-name">${Ae(o.name)}</span>
  ...
  `,a){ne({type:"trivia-interlude",scores:n});let o=3;A=setInterval(()=>{o--,Ha();const i=document.getElementById("interlude-count");i&&(i.textContent=o),o<=0&&(clearInterval(A),A=null,La())},1e3)}else setTimeout(en,1500)}function en(){var e,a;const n=[...f.values()].map(s=>({name:s.name,score:s.score})).sort((s,t)=>t.score-s.score);G="end",ra=n;const o=(e=(a=n[0])===null||a===void 0?void 0:a.score)!==null&&e!==void 0?e:0,i=n.filter(s=>s.score===o&&o>0),l=i.length>1?"EMPATE":i.length?"GANADOR":"FIN";Fa(),fe(n[0]?"#2e5fa8":"#a78bfa"),ye.innerHTML=`
    <div class="scene">
      <h1 class="title" style="font-size:2rem;margin-bottom:4px">${l}</h1>
      ${i.length?i.map(s=>`<div class="winner-name">${Ae(s.name)}</div>`).join(""):'<div class="winner-name">—</div>'}
      <div class="trivia-scoreboard" style="margin-top:24px">
        ${n.map((s,t)=>`
          <div class="score-row">
            <span class="score-rank">${t+1}</span>
            <span class="score-name">${Ae(s.name)}</span>
      ...
      <div class="end-join-block">
        ...
        <span class="end-join-code">${ta}</span>
      </div>
  ...
  `,ne({type:"trivia-end",scores:n}),document.getElementById("again-btn").focus(),document.getElementById("again-btn").onclick=()=>Nn(),document.getElementById("menu-btn").onclick=()=>{var s;return(s=oa)===null||s===void 0?void 0:s()}}function Nn(){ge=!1,A&&(clearInterval(A),A=null),L=Ya(xe).slice(0,na),f.forEach(e=>{e.score=0,e.answered=!1}),ne({type:"trivia-start",total:L.length}),S=-1,La()}function Ye(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function On(e,a){oe=e,ca=a,Z=0,Ne=0,Y=!1,ve(),zn(),Dn(e)}function zn(){if(da)return;da=!0;const e=()=>{if(document.visibilityState!=="visible"||!Ge||!N)return;const a=Ma();a?.mode==="trivia"&&(Ie()||an(Ge,N))};document.addEventListener("visibilitychange",e),window.addEventListener("focus",e),window.addEventListener("online",e)}function ve(){ie&&(clearInterval(ie),ie=null),re&&(clearInterval(re),re=null)}function Dn(e){e.innerHTML=`
    <div class="scene">
      <h1 class="title">TRIVIA</h1>
  ...
  `;const a=()=>{const n=document.getElementById("code-input").value.trim(),o=document.getElementById("name-input").value.trim(),i=document.getElementById("status");if(n.length!==4){i.textContent="Ingresa el código de 4 dígitos";return}if(!o){i.textContent="Ingresa tu nombre";return}document.getElementById("join-btn").disabled=!0,i.textContent="Conectando…",an(n,o)};document.getElementById("join-btn").onclick=a,document.getElementById("name-input").addEventListener("keydown",n=>{n.key==="Enter"&&a()})}function an(e,a){Ge=e,N=a,Ea({mode:"trivia",code:e,name:a}),Me(),b("connected",()=>{M({type:"trivia-join",name:N,clientId:We()})}),b("message",n=>{n.type==="trivia-waiting"&&nn(oe),n.type==="trivia-start"&&(Ne=n.total,Z=0,nn(oe)),n.type==="trivia-question"&&jn(oe,n),n.type==="trivia-feedback"&&Fn(n.correct),n.type==="trivia-reveal"&&Hn(n.correctIndex),n.type==="trivia-interlude"&&Jn(oe,n),n.type==="trivia-end"&&Vn(oe,n.scores)}),b("error",n=>{const o=document.getElementById("status");o&&(o.textContent=n.type==="peer-unavailable"?"❌ Código incorrecto — revisa el televisor":`❌ ${n.type}`);const i=document.getElementById("join-btn");i&&(i.disabled=!1)}),fa(e)}function nn(e){ve(),e.innerHTML=`
    <div class="scene">
      <h1 class="title">TRIVIA</h1>
      <p class="label">¡Conectado como <strong style="color:#fff">${Ye(N)}</strong>!</p>
      <p class="label" style="opacity:0.45;margin-top:4px">Esperando que el televisor empiece…</p>
    </div>
  `}function jn(e,a){Y=!!a.alreadyAnswered,ze=-1,Oe=a.answer,typeof a.myScore=="number"&&(Z=a.myScore),ve();const n="background:rgba(46,95,168,0.12);";e.innerHTML=`
    <div class="scene board-scene">
  ...
  `,document.querySelectorAll(".trivia-phone-option").forEach(s=>{if(Y){s.disabled=!0;return}s.addEventListener("click",()=>{if(Y)return;Y=!0,Se(),ve();const t=parseInt(s.dataset.idx);ze=t,M({type:"trivia-answer",answerIndex:t,questionIndex:a.index,clientId:We()}),document.querySelectorAll(".trivia-phone-option").forEach(F=>{F.disabled=!0}),s.style.outline="4px solid white",s.style.outlineOffset="-4px",document.getElementById("phone-status").textContent="¡Respuesta enviada!"})});const o=document.getElementById("phone-score");o&&(o.textContent=`${Z} pts`),Y&&(document.getElementById("phone-status").textContent="¡Respuesta enviada!");const i=typeof a.remainingMs=="number"?a.remainingMs:15e3;let r=Math.max(0,Math.ceil(i/1e3));const l=document.getElementById("phone-timer");l&&(l.textContent=r),ie=setInterval(()=>{r--,l&&(l.textContent=r,r<=3&&(l.className="trivia-phone-timer timer-urgent")),r<=0&&(clearInterval(ie),ie=null)},1e3)}function Fn(e){e&&Z++;const a=document.getElementById("phone-status");a&&(a.textContent=e?"✓ ¡Correcto!":"✗ Incorrecto",a.style.color=e?"#4ade80":"#f87171");const n=document.getElementById("phone-score");n&&(n.textContent=`${Z} pts`),document.querySelectorAll(".trivia-phone-option").forEach(o=>{const i=parseInt(o.dataset.idx);o.style.outline="",o.style.outlineOffset="",i===Oe?o.classList.add("opt-correct"):i===ze?o.classList.add("opt-mine-wrong"):o.classList.add("opt-wrong")}),e?Ve():ja()}function Hn(e){if(Y)return;Oe=e,document.querySelectorAll(".trivia-phone-option").forEach(n=>{const o=parseInt(n.dataset.idx);n.disabled=!0,o===e?n.classList.add("opt-correct"):n.classList.add("opt-wrong")});const a=document.getElementById("phone-status");a&&(a.textContent="⏱ Tiempo agotado",a.style.color="#f87171")}function Jn(e,a){ve();const n=a.scores;e.innerHTML=`
    <div class="scene">
      <h2 class="trivia-interlude-title">PUNTAJES</h2>
      <div class="trivia-scoreboard">
        ${n.map((i,r)=>`
          <div class="score-row ${i.name===N?"score-row-me":""}">
            ...
            <span class="score-name">${Ye(i.name)}</span>
  ...
  `;let o=3;re=setInterval(()=>{o--,Ha();const i=document.getElementById("phone-interlude-count");i&&(i.textContent=o),o<=0&&(clearInterval(re),re=null)},1e3)}function Vn(e,a){var n,o,i;ve();const r=a.find(E=>E.name===N),l=a.findIndex(E=>E.name===N)+1,s=(n=(o=a[0])===null||o===void 0?void 0:o.score)!==null&&n!==void 0?n:0,t=a.filter(E=>E.score===s&&s>0),F=t.some(E=>E.name===N),dn=t.length>1;F&&fe("#2e5fa8");let Ze;F&&dn?Ze='<h1 class="title" style="font-size:2rem">🏆 ¡EMPATE!</h1>':F?Ze='<h1 class="title" style="font-size:2rem">🏆 ¡GANASTE!</h1>':Ze='<h1 class="title" style="font-size:1.6rem;opacity:0.7">FIN</h1>';let un="";!F&&t.length&&(un=`
      <div style="text-align:center;margin-top:-4px">
        <div style="font-size:0.85rem;letter-spacing:0.1em;color:rgba(255,255,255,0.45);font-weight:700">${dn?"GANADORES":"GANADOR"}</div>
        <div class="winner-name" style="font-size:clamp(1.4rem,5vw,2.4rem);margin-top:2px">
          ${t.map(ka=>Ye(ka.name)).join(" · ")}
        </div>
      </div>
    `),e.innerHTML=`
    <div class="scene">
      ...
      <div class="trivia-my-score">
        ...
        <div class="trivia-my-score-label">de ${Ne} correctas</div>
        <div class="trivia-my-score-rank">Puesto ${l} de ${a.length}</div>
      </div>
      <div class="trivia-scoreboard">
        ${a.map((E,ka)=>`
          <div class="score-row ${E.name===N?"score-row-me":""}">
            <span class="score-rank">${ka+1}</span>
            <span class="score-name">${Ye(E.name)}</span>
  ...
  `,document.getElementById("menu-btn").onclick=()=>{var E;Ue(),(E=ca)===null||E===void 0||E()}}function te(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Wn(e,a){W=e,qe=a,on(),B=null,Ce=null,c="lobby",U=Le(),tn(),b("connected",()=>{}),b("peer-left",n=>{n===B&&(B=null,C&&(clearInterval(C),C=null),to())}),b("message",(n,o)=>{if(n.type==="mimica-hello")return Un(o,n.clientId);if(n.type==="mimica-setup-teams")return Kn(n.count);if(n.type==="mimica-begin-turn")return _n();if(n.type==="mimica-correct")return Yn();if(n.type==="mimica-skip")return Zn();if(n.type==="mimica-next-team")return Xn();if(n.type==="mimica-restart")return eo()}),ba(U)}function on(){C&&(clearInterval(C),C=null),Fe="",be=new Set,u=[],m=0,O=0,R=0}function Un(e,a){var n;const o=a&&a===Ce,i=!((n=B)!==null&&n!==void 0&&n.open);o||i?(B=e,Ce=a||Ce,Ca(),c==="lobby"&&(c="setup"),c==="playing"&&!C&&rn(),K(),le()):d(e,{type:"mimica-rejected",reason:"captain-taken"})}function K(){B&&(c==="setup"?d(B,{type:"mimica-setup-needed"}):c==="turn-ready"?d(B,{type:"mimica-turn-ready",teams:u,currentTeamIdx:m}):c==="playing"?d(B,{type:"mimica-word",word:Fe,remaining:R,aciertosThisTurn:O,teams:u,currentTeamIdx:m}):c==="turn-end"?d(B,{type:"mimica-turn-end",teams:u,currentTeamIdx:m,aciertosThisTurn:O,hasMore:m<u.length-1}):c==="game-end"&&d(B,{type:"mimica-game-end",teams:u}))}function Kn(e){if(c!=="setup")return;const a=Math.max(2,Math.min(6,Number(e)||0));u=Array.from({length:a},(n,o)=>({name:`Equipo ${o+1}`,score:0})),m=0,O=0,c="turn-ready",K(),le()}function _n(){c==="turn-ready"&&(O=0,R=Ga,c="playing",Ia(),rn(),K(),le())}function Yn(){c==="playing"&&(O++,u[m].score++,Ve(),Ia(),K(),ln())}function Zn(){c==="playing"&&(Ia(),K(),ln())}function Xn(){if(c==="turn-end"){if(m>=u.length-1){ao();return}m++,O=0,c="turn-ready",K(),le()}}function eo(){c==="game-end"&&(on(),c="setup",K(),le())}function Ia(){be.size>=De.length&&be.clear();let e;do e=De[Math.floor(Math.random()*De.length)];while(be.has(e));be.add(e),Fe=e}function rn(){C&&clearInterval(C),C=setInterval(()=>{R--;const e=document.getElementById("mimica-timer");e&&(e.textContent=R,e.className="mimica-timer"+(R<=5?" timer-urgent":"")),R>0&&R<=5&&qa(),R<=0&&(clearInterval(C),C=null,Da(),c="turn-end",K(),le())},1e3)}function ao(){var e;c="game-end",C&&(clearInterval(C),C=null),Fa();const a=[...u].sort((n,o)=>o.score-n.score);fe((e=je[u.indexOf(a[0])])!==null&&e!==void 0?e:"#2e5fa8"),K(),le()}function le(){if(c==="lobby")return tn();if(c==="setup")return no();if(c==="turn-ready")return oo();if(c==="playing")return io();if(c==="turn-end")return ro();if(c==="game-end")return so()}function ee(e){return je[e%je.length]}function sn(e=-1){return`
  ...
  `,document.getElementById("menu-btn").onclick=()=>{var e;return(e=qe)===null||e===void 0?void 0:e()}}function no(){W.innerHTML=`
    <div class="scene">
      <h1 class="title">MÍMICA</h1>
  ...
  `}function oo(){const e=u[m];W.innerHTML=`
    <div class="scene mimica-scene">
      ...
      <div class="mimica-foot">${sn(m)}</div>
    </div>
  `}function io(){const e=u[m];W.innerHTML=`
    <div class="scene mimica-scene">
      <div class="mimica-top">
  ...
  `}function ln(){const e=document.getElementById("mimica-aciertos");e&&(e.textContent=O)}function ro(){const e=u[m],a=m>=u.length-1;W.innerHTML=`
    <div class="scene mimica-scene">
      <div class="mimica-top">
        <span class="mimica-code">${U}</span>
        <span class="mimica-progress">Turno ${m+1} / ${u.length}</span>
  ...
  `}function so(){var e,a;const n=[...u].sort((s,t)=>t.score-s.score),o=(e=(a=n[0])===null||a===void 0?void 0:a.score)!==null&&e!==void 0?e:0,i=n.filter(s=>s.score===o&&o>0),l=i.length>1?"EMPATE":i.length?"GANA":"FIN";W.innerHTML=`
    <div class="scene">
      <h1 class="title" style="font-size:2rem;margin-bottom:4px">${l}</h1>
  ...
  `,document.getElementById("menu-btn").onclick=()=>{var s;return(s=qe)===null||s===void 0?void 0:s()}}function to(){W.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("menu-btn").onclick=()=>{var e;return(e=qe)===null||e===void 0?void 0:e()}}function ce(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function lo(e,a){X=e,He=a,co(),uo(e)}function co(){if(pa)return;pa=!0;const e=()=>{if(document.visibilityState!=="visible"||!Je)return;const a=Ma();a?.mode==="mimica"&&(Ie()||cn(Je))};document.addEventListener("visibilitychange",e),window.addEventListener("focus",e),window.addEventListener("online",e)}function j(e){return ua[e%ua.length]}function uo(e){e.innerHTML=`
    <div class="scene">
      <h1 class="title">MÍMICA</h1>
  ...
  `;const a=document.getElementById("code-input"),n=document.getElementById("connect-btn"),o=document.getElementById("status"),i=()=>{const r=a.value.trim();if(r.length!==4){o.textContent="Ingresa el código de 4 dígitos";return}n.disabled=!0,o.textContent="Conectando…",cn(r)};n.onclick=i,a.addEventListener("keydown",r=>{r.key==="Enter"&&i()})}function cn(e){Je=e,Ea({mode:"mimica",code:e}),Me(),ae(),b("connected",()=>{M({type:"mimica-hello",clientId:We()})}),b("message",a=>{if(a.type==="mimica-setup-needed")return po();if(a.type==="mimica-turn-ready")return mo(a);if(a.type==="mimica-word")return go(a);if(a.type==="mimica-turn-end")return vo(a);if(a.type==="mimica-game-end")return ho(a);if(a.type==="mimica-rejected")return wo()}),b("error",a=>{const n=document.getElementById("status");n&&(n.textContent=a.type==="peer-unavailable"?"❌ Código incorrecto — revisa el televisor":`❌ ${a.type}`);const o=document.getElementById("connect-btn");o&&(o.disabled=!1)}),fa(e)}function po(){ae(),X.innerHTML=`
    <div class="scene">
  ...
  `,document.querySelectorAll(".mimica-setup-btn").forEach(e=>{e.onclick=()=>{Se(),M({type:"mimica-setup-teams",count:parseInt(e.dataset.n)})}})}function mo(e){ae(),T=e.teams,I=e.currentTeamIdx;const a=T[I];X.innerHTML=`
    <div class="scene">
      <p class="mimica-ready-label" style="font-size:clamp(0.9rem,3vw,1.1rem);color:rgba(255,255,255,0.55)">TURNO DEL</p>
      <h1 class="title" style="font-size:clamp(2.4rem,10vw,4rem);color:${j(I)};margin:8px 0 16px">${ce(a.name)}</h1>
      ...
      <div class="mimica-mini-scoreboard">
        ${T.map((o,i)=>`
          <div class="mimica-mini-row ${i===I?"mimica-mini-row-current":""}" style="--team-color:${j(i)}">
            <span class="mimica-score-dot"></span>
            <span class="mimica-score-name">${ce(o.name)}</span>
            <span class="mimica-score-pts">${o.score}</span>
          </div>
        `).join("")}
      </div>
    </div>
  `;const n=document.getElementById("begin-btn");n.focus(),n.onclick=()=>{Se(),M({type:"mimica-begin-turn"})}}function go(e){ma=e.word,D=e.remaining,se=e.aciertosThisTurn,T=e.teams,I=e.currentTeamIdx,bo(),fo()}function bo(){const e=T[I];X.innerHTML=`
    <div class="scene mimica-phone-scene">
      <div class="mimica-phone-top" style="border-bottom-color:${j(I)}55">
        <span class="mimica-team-tag" style="background:${j(I)}22;color:${j(I)}">${ce(e.name)}</span>
  ...
  `,document.getElementById("correct-btn").onclick=()=>{Ve(),se++;const a=document.getElementById("phone-aciertos");a&&(a.textContent=se),M({type:"mimica-correct"})},document.getElementById("pass-btn").onclick=()=>{ja(),M({type:"mimica-skip"})}}function fo(){ae(),Ee=setInterval(()=>{D--;const e=document.getElementById("mimica-phone-timer");e&&(e.textContent=`${D}s`,D<=5&&e.classList.add("timer-urgent")),D>0&&D<=5&&qa(),D<=0&&ae()},1e3)}function ae(){Ee&&(clearInterval(Ee),Ee=null)}function vo(e){ae(),T=e.teams,I=e.currentTeamIdx,se=e.aciertosThisTurn;const a=T[I],n=!e.hasMore;X.innerHTML=`
    <div class="scene">
      <div class="mimica-timeup-label" style="margin-top:0">¡TIEMPO!</div>
      <h1 class="title" style="font-size:clamp(1.6rem,6vw,2.4rem);color:${j(I)};margin:8px 0">${ce(a.name)}</h1>
      ...
      <div class="mimica-mini-scoreboard">
        ${T.map((i,r)=>`
          <div class="mimica-mini-row ${r===I?"mimica-mini-row-current":""}" style="--team-color:${j(r)}">
            <span class="mimica-score-dot"></span>
            <span class="mimica-score-name">${ce(i.name)}</span>
  ...
  `;const o=document.getElementById("next-btn");o.focus(),o.onclick=()=>{Se(),M({type:"mimica-next-team"})}}function ho(e){var a,n;ae(),T=e.teams;const o=[...T].sort((t,F)=>F.score-t.score),i=(a=(n=o[0])===null||n===void 0?void 0:n.score)!==null&&a!==void 0?a:0,r=o.filter(t=>t.score===i&&i>0),s=r.length>1?"🏆 ¡EMPATE!":r.length?"🏆 ¡GANADOR!":"FIN";X.innerHTML=`
    <div class="scene">
      <h1 class="title" style="font-size:2rem;margin-bottom:8px">${s}</h1>
      ${r.length?r.map(t=>`<div class="winner-name" style="color:${j(T.indexOf(t))}">${ce(t.name)}</div>`).join(""):'<div class="winner-name">—</div>'}
      <div class="mimica-mini-scoreboard" style="margin-top:24px">
        ${o.map(t=>{const F=T.indexOf(t);return`
          <div class="mimica-mini-row" style="--team-color:${j(F)}">
            <span class="mimica-score-dot"></span>
            <span class="mimica-score-name">${ce(t.name)}</span>
  ...
  `,document.getElementById("again-btn").focus(),document.getElementById("again-btn").onclick=()=>{Se(),M({type:"mimica-restart"})},document.getElementById("menu-btn").onclick=()=>{var t;Ue(),(t=He)===null||t===void 0||t()}}function wo(){ae(),X.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("back-btn").onclick=()=>{var e;Ue(),(e=He)===null||e===void 0||e()}}function yo(e,a){n();function n(){const o=Oa(),i=q[o.isTeamOneFirst?0:1];e.innerHTML=`
      <div class="scene board-scene">
    ...
    `;const r=document.getElementById("board");o.tiles.forEach(l=>{const s=document.createElement("div");s.className="tile",s.dataset.type=l,s.style.background=q[l],s.addEventListener("click",()=>{const t=!s.classList.contains("checked");s.classList.toggle("checked",t),t?(va(s),ha(l)):wa()}),r.appendChild(s)}),document.getElementById("back-btn").onclick=a,document.getElementById("new-map-btn").onclick=()=>{confirm("¿Generar un nuevo mapa?")&&(ya(),n())}}}function qo(){ga||(ga=!0,document.addEventListener("keydown",e=>{if(e.key!=="ArrowDown"&&e.key!=="ArrowUp")return;const a=[...document.querySelectorAll(".btn")];if(!a.length)return;const n=a.indexOf(document.activeElement);e.key==="ArrowDown"&&a[Math.min(n+1,a.length-1)].focus(),e.key==="ArrowUp"&&a[Math.max(n-1,0)].focus(),e.preventDefault()}))}function Ta(e){Me(),Ue(),qo(),e.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("cs-btn").focus(),document.getElementById("cs-btn").onclick=()=>Qa(e,"cs"),document.getElementById("trivia-btn").onclick=()=>Qa(e,"trivia"),document.getElementById("mimica-btn").onclick=()=>Qa(e,"mimica"),document.getElementById("mapa-btn").onclick=()=>yo(e,()=>Ta(e))}function Qa(e,a){Me();const o={cs:"CÓDIGO SECRETO",trivia:"TRIVIA",mimica:"MÍMICA"}[a];e.innerHTML=`
    <div class="scene">
  ...
  `,document.getElementById("tv-btn").focus();const i=()=>Ta(e);document.getElementById("tv-btn").onclick=()=>{if(a==="cs")return vn(e);if(a==="trivia")return Qn(e,i);if(a==="mimica")return Wn(e,i)},document.getElementById("phone-btn").onclick=()=>{if(a==="cs")return Mn(e);if(a==="trivia")return On(e,i);if(a==="mimica")return lo(e,i)},document.getElementById("back-btn").onclick=i}return{setters:[],execute:function(){v=typeof window<"u"&&window.CODIGO_WS_URL||"",w=new Map,Q=(e,...a)=>{var n;return(n=w.get(e))===null||n===void 0?void 0:n(...a)},b=(e,a)=>w.set(e,a),h=null,de=null,ue=new Map,Le=()=>String(Math.floor(1e3+Math.random()*9e3)),M=e=>{var a;((a=h)===null||a===void 0?void 0:a.readyState)===WebSocket.OPEN&&h.send(JSON.stringify({type:"to-host",payload:e}))},d=(e,a)=>{var n;((n=h)===null||n===void 0?void 0:n.readyState)===WebSocket.OPEN&&h.send(JSON.stringify({type:"to-peer",peerId:e.id,payload:a}))},ne=e=>{var a;((a=h)===null||a===void 0?void 0:a.readyState)===WebSocket.OPEN&&h.send(JSON.stringify({type:"broadcast",payload:e}))},Ie=()=>{var e;return((e=h)===null||e===void 0?void 0:e.readyState)===WebSocket.OPEN&&de==="phone"},Ba=`
abogado
aceite
áfrica
agente
