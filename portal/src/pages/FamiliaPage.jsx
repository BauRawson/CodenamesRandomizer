...
export default function FamiliaPage() {
  ...
  return (
    <main className="max-w-7xl mx-auto py-8 px-4">
      {/* Header */}
      <div className="bg-gradient-to-br from-purple-600 to-purple-900 rounded-3xl px-8 py-12 mb-10 text-white text-center relative overflow-hidden">
      ...
      <section className="mb-10">
        <h2 className="font-black text-2xl text-white mb-5">¿Cómo funciona?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={s.step} className="bg-brand-surface rounded-2xl p-6 border border-white/10 flex gap-4">
              <div className="w-10 h-10 bg-purple-900/50 rounded-full flex items-center justify-center font-black text-purple-300 flex-shrink-0">
                {s.step}
              </div>
              <div>
                <p className="font-black text-white mb-1">{s.icon} {s.title}</p>
      ...
      {/* Games grid */}
      <section>
        <h2 className="font-black text-2xl text-white mb-5">Juegos disponibles</h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5">
          ...
          <div className="flex flex-col gap-3 w-fit">
            ...
            >
              ...
              <div className="p-3">
                <p className="font-bold text-white text-sm leading-tight truncate">Mapa</p>
                <p className="text-xs text-gray-500 mt-0.5">herramienta</p>
              </div>
            </a>
            <a
              href="/play/codigo-secreto.html?mode=mapa"
      ...
      {/* Tech note */}
      <div className="mt-8 bg-brand-surface rounded-2xl p-6 border border-white/10">
        <p className="font-black text-white mb-1">🔧 Tecnología</p>
