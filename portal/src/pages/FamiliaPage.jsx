  ...
  return (
    <main className="max-w-7xl mx-auto py-8 px-4">
      ...
      <section className="mb-10">
        <h2 className="font-black text-2xl text-gray-900 mb-5">¿Cómo funciona?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={s.step} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex gap-4">
              <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center font-black text-gray-700 flex-shrink-0">
                {s.step}
              </div>
              <div>
      ...
      {/* Games grid */}
      <section>
        <h2 className="font-black text-2xl text-gray-900 mb-5">Juegos disponibles</h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5">
          {familyGames.map(game => (
            <div key={game.id} className="flex flex-col gap-3 w-fit">
              ...
              {!game.coming_soon && (
                <Link
                  to={`/play/${game.slug}`}
                  className="text-center bg-gray-900 text-white font-black py-2.5 rounded-xl hover:bg-gray-700 transition-colors text-sm"
                >
                  ▶ Jugar
                </Link>
              )}
          ...
          <div className="flex flex-col gap-3 w-fit">
            ...
            >
              ...
              <div className="p-3">
                <p className="font-bold text-gray-900 text-sm leading-tight truncate">Mapa</p>
      ...
      <div className="mt-8 bg-gray-50 rounded-2xl p-6 border border-gray-100">
        <p className="font-black text-gray-900 mb-1">🔧 Tecnología</p>
